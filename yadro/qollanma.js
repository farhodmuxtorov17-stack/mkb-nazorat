  ...
  nazorat: {
    ...
    qadamlar: [
      ...
      {nom: "Jonli tashrifni kuzating",
       ...
       havola: "tashriflar.html", havolaNomi: "Tashriflar"},
      ...
      {nom: "Tugayotgan polislarni yangilang",
       ...
       havola: "sugurta.html", havolaNomi: "Sug'urta polislari"},
    ],
    javobgarlik: [
  ...
  baholash: {
    ...
    qadamlar: [
      ...
      {nom: "Dinamikani tekshiring",
       ...
       havola: "baholash.html", havolaNomi: "Baholash reyestri"},
    ],
    javobgarlik: [
  ...
  filial: {
    ...
    qadamlar: [
      ...
      {nom: "Filial kesimidagi hisobotni oching",
       ...
       havola: "hisobot-hudud.html", havolaNomi: "Hudud kesimi"},
  ...
  admin: {
    ...
    qadamlar: [
      ...
      {nom: "Ma'lumotnomalarni yangilang",
       ...
       havola: "filiallar.html", havolaNomi: "Filiallar"},
