...
window.MKB_SAYOHATLAR = {
  ...
  "rahbariyat-tanishuv": {
    ...
    qadamlar: [
      ...
      Q("korik-kechikkan.html", S("jadval"), "Kechikkan ko'riklar", "Просроченные осмотры", "Muddati o'tgan ko'rik sizga o'tkaziladi. Qatorlarni belgilang, yangi sanani tanlang va «Ko'chirish»ni bosing: sabab tarixda qoladi.",
  ...
  "nazorat-tanishuv": {
    ...
    qadamlar: [
      ...
      Q("panel-nazorat.html", S("kpi"), "Bugungi raqamlar", "Цифры на сегодня", "7 kundagi ko'riklar, kechikkanlar, ochiq hodisalar, sug'urtasiz aktivlar va 24 soatdan ortiq aloqasiz qurilmalar.",
        "Осмотры на 7 дней, просроченные, открытые происшествия, активы без страховки и устройства без связи более 24 часов."),
      ...
      Q("panel-nazorat.html", S("hodisalar"), "Ochiq hodisalar", "Открытые происшествия", "Jiddiylik bo'yicha. Hodisani bossangiz, uning varaqasi ochiladi. Hodisa endi shu roldan boshlanib shu rolda yopiladi.",
        "По важности. Нажмите на происшествие, чтобы открыть его карточку. Происшествие теперь открывается и закрывается в этой же роли."),
      ...
      Q("korik-rejasi.html", S("jadval"), "Ko'rik rejasi", "План осмотров", "Rejadagi hamma ko'rik. Qatordagi «O'tkazish» dalolatnoma formasini ochadi; baho 2 yoki 1 bo'lsa hodisa o'zi ochiladi.",
        "Все плановые осмотры. «O'tkazish» в строке открывает форму акта; при оценке 2 или 1 происшествие откроется само."),
      ...
      Q("himoya.html", S("kameralar"), "Monitoring markazi", "Центр мониторинга", "Har bir kamera: oxirgi kadr, batareya, signal vaqti va ochiq hodisa. Kadr — kameradan kelgan oxirgi surat, jonli video emas. Yuqoridagi plitkalar ro'yxatni holat bo'yicha saralaydi.",
        "Каждая камера: последний кадр, заряд, время сигнала и открытое происшествие. Кадр — последний снимок с камеры, а не живое видео. Плитки сверху отбирают список по состоянию."),
    ],
  },
  ...
  "admin-tanishuv": {
    ...
    qadamlar: [
      ...
      Q("sozlamalar.html", S("menyu"), "Sozlamalar bo'limlari", "Разделы настроек", "«Yuqoriga o'tkazish qoidalari» — muddatdan necha kun oldin kimga bildirishnoma yoki vazifa ketishi va javob bo'lmasa kimga o'tishi. «Me'yoriy parametrlar» — muddat, zaxira va savdo hisoblari shu qiymatlardan olinadi. Har o'zgarish amallar tarixiga yoziladi.",
        "«Yuqoriga o'tkazish qoidalari» — за сколько дней до срока и кому уходит уведомление или задача и к кому она переходит без ответа. «Me'yoriy parametrlar» — из этих значений считаются сроки, резерв и торги. Каждое изменение записывается в журнал."),
  ...
  "korik-otkazish": {
    ...
    qadamlar: [
      ...
      Q(REJADAGI_KORIK, S("yakunlash"), "Dalolatnomani yakunlash", "Завершить акт", "Tizim suratlarni tekshiradi va tasdiqlash oynasini ochadi. Baho 2 yoki 1 bo'lsa, hodisa o'zi ochiladi. Aloqa uzilsa ham qoralama shu qurilmada qoladi.",
        "Система проверяет фото и открывает окно подтверждения. При оценке 2 или 1 происшествие открывается само. Даже при обрыве связи черновик остаётся на устройстве."),
    ],
  },
  ...
  "inventarizatsiya": {
    ...
    qadamlar: [
      ...
      Q("inventarizatsiya.html", S("jadval"), "Inventar ro'yxati", "Инвентарный список", "«QR yorliqlar» chop etish uchun. Topilmagan birlik kamomad bo'lib dalolatnomaga kiradi va hodisa ochiladi.",
        "«QR yorliqlar» — для печати. Ненайденная единица попадает в акт как недостача, открывается происшествие."),
    ],
  },
  ...
  "hodisa-hal-qilish": {
    rol: ["nazorat", "obyekt", "admin"], rejim: "sayohat",
    sarlavha: T("Hodisani hal qilish", "Решение происшествия"),
    tavsif: T("Qayd etishdan yopishgacha", "От регистрации до закрытия"),
    qadamlar: [
      Q("hodisalar.html", S("qayd"), "Hodisa qayd etish", "Регистрация происшествия", "Obyekt, tur, jiddiylik va tavsif. Hodisa «Yangi» ustuniga tushadi.", "Объект, тип, важность и описание. Происшествие попадает в колонку «Yangi»."),
      Q("hodisalar.html", S("doska"), "Doska", "Доска", "Ustunlar hodisa bosqichlari. Bosqichlar ketma-ket o'tkaziladi.", "Колонки — этапы происшествия. Этапы проходятся по порядку."),
      ...
      Q(OCHIQ_HODISA, R("hodisa-keyingi"), "Keyingi bosqich tugmasi", "Кнопка следующего этапа", "«Qabul qilish» hodisani tekshiruvga oladi, mas'ul bo'lmasa siz mas'ul bo'lasiz. 8 soniya ichida qaytarish mumkin.",
        "«Qabul qilish» берёт происшествие на проверку; если ответственного нет, им становитесь вы. Отменить можно в течение 8 секунд."),
  ...
  "qanday-monitoring": {
    ...
    qadamlar: [
      ...
      Q("himoya.html", S("signal-navbat"), "Signaldan hodisaga", "От сигнала к происшествиеу", "Jiddiy signalni bossangiz, u haqida batafsil ma'lumot ochiladi, kerak bo'lsa hodisa qayd etasiz.", "Нажмите на серьёзный сигнал, чтобы открыть подробности и при необходимости зарегистрировать происшествие."),
    ],
  },
