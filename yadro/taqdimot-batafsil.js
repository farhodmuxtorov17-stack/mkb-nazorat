...
Object.assign(window.MKB_BATAFSIL, {
  ...
  "s-yol.birinchi": {
    ...
    tana: "<p>Birinchi 50 obyekt ro'yxati ikki mezon ko'paytmasidan tuziladi: balans qiymati va xavf darajasi. Qimmat, chekkada turgan va qo'shnisi yo'q bino ro'yxat boshiga chiqadi.</p><h4>Xavf balli</h4><ul><li>Ilgari buzib kirish yoki talon holati bo'lganmi.</li><li>Eng yaqin aholi punktigacha masofa.</li><li>Ichida qimmat jihoz yoki material qolganmi.</li><li>Balansga olinganiga necha oy bo'lgan: bir yilga yaqinlashgan obyekt zaxira talabi tufayli birinchi navbatda.</li></ul><h4>Shu bosqichda boshlanadi</h4><ul><li><b>Navbatchi smena.</b> Bitta post 24/7 ishlashi uchun 4–5 shtat birligi kerak: haftada 168 soat, bir xodimga 40 soat. Beshinchisi ta'til va kasallik uchun. <span data-slayd-raqam=\"#s-iqtisod\"></span>-slayddagi hisobda 4 operator olingan.</li><li><b>Tender.</b> Bosh integrator uchun kamida uchta tijorat taklifi.</li><li><b>Qo'riqlash departamenti.</b> O'RQ-778 bo'yicha xabar kelganda chiqish faqat davlat qo'riqlash xizmati bilan shartnoma asosida.</li></ul><p class='ogoh'>Byudjet 50 obyektga tanlangan yechimlar aralashmasiga bog'liq: <span data-slayd-raqam=\"#s-narx\"></span>-slayddagi diapazonlar bo'yicha taxminan 0,4–1 mlrd so'm.</p>",
    manba: [],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "50 объектов: с кого начинаем",
      tana: "<p>Список первых 50 объектов строится по произведению двух критериев: балансовой стоимости и уровня риска. Дорогое здание на отшибе без соседей оказывается в начале списка.</p><h4>Балл риска</h4><ul><li>Были ли ранее проникновения или хищения.</li><li>Расстояние до ближайшего населённого пункта.</li><li>Осталось ли внутри дорогое оборудование или материалы.</li><li>Сколько месяцев объект на балансе: те, кто подходит к году, идут первыми из-за требования о резерве.</li></ul><h4>Что стартует на этом этапе</h4><ul><li><b>Дежурная смена.</b> Для круглосуточного поста нужно 4–5 штатных единиц: 168 часов в неделю, 40 часов на сотрудника. Пятая — на отпуска и больничные. В расчёте на слайде <span data-slayd-raqam=\"#s-iqtisod\"></span> заложено 4 оператора.</li><li><b>Тендер.</b> Не менее трёх коммерческих предложений на генерального интегратора.</li><li><b>Департамент охраны.</b> По ЗРУ-778 выезд по тревоге — только по договору с государственной службой охраны.</li></ul><p class='ogoh'>Бюджет на 50 объектов зависит от набора решений: по диапазонам со слайда <span data-slayd-raqam=\"#s-narx\"></span> — ориентировочно 0,4–1 млрд сумов.</p>"
    }
  },
  ...
  "s-uzilish.tamoyil6": {
    ...
    tana: "<p>Doimiy video uzatilmagani uchun SIM trafigi kichik va oldindan hisoblanadi. Hisob 4 qurilmali obyekt uchun, taxminiy.</p><table><tr><th>Nima</th><th>Kuniga</th><th>Oyiga</th></tr><tr><td>Heartbeat va telemetriya</td><td class='n'>≈ 1,5 MB</td><td class='n'>≈ 45 MB</td></tr><tr><td>Hodisa kadrlari, 120 × 200 KB</td><td class='n'>24 MB</td><td class='n'>0,72 GB</td></tr><tr><td>Kliplar, 12 × 1 MB</td><td class='n'>12 MB</td><td class='n'>0,36 GB</td></tr><tr><td>Jonli ko'rish, 30 daqiqa</td><td class='n'>115 MB</td><td class='n'>3,45 GB</td></tr><tr><td>Jami</td><td class='n'>≈ 153 MB</td><td class='n'>≈ 4,6 GB</td></tr></table><p>Jonli ko'rish farazi <span data-slayd-raqam=\"#s-video\"></span>-slayddagi bilan bir xil. VPN va TLS qo'shimchasi bilan 5–6 GB paket yetadi. Tarif cheklanmagan bo'lishi shart emas.</p><h4>Xarid uchun</h4><ul><li>Operator bilan korporativ shartnoma: barcha SIM bitta hisobda, oylik limit va ogohlantirish.</li><li>Trafik limitdan oshsa, platforma obyekt kesimida ko'rsatadi: odatda bu shamolda tebranayotgan daraxt tufayli ko'p hodisa beradigan kamera.</li></ul>",
    manba: [],
    ru: {
      yorliq: "Финансы и право",
      sarlavha: "Трафик: сколько на объект в месяц",
      tana: "<p>Постоянного видео нет, поэтому трафик SIM небольшой и считается заранее. Расчёт для объекта с 4 устройствами, ориентировочный.</p><table><tr><th>Что</th><th>В сутки</th><th>В месяц</th></tr><tr><td>Heartbeat и телеметрия</td><td class='n'>≈ 1,5 МБ</td><td class='n'>≈ 45 МБ</td></tr><tr><td>Кадры событий, 120 × 200 КБ</td><td class='n'>24 МБ</td><td class='n'>0,72 ГБ</td></tr><tr><td>Клипы, 12 × 1 МБ</td><td class='n'>12 МБ</td><td class='n'>0,36 ГБ</td></tr><tr><td>Живой просмотр, 30 минут</td><td class='n'>115 МБ</td><td class='n'>3,45 ГБ</td></tr><tr><td>Итого</td><td class='n'>≈ 153 МБ</td><td class='n'>≈ 4,6 ГБ</td></tr></table><p>Допущение по живому просмотру то же, что на слайде <span data-slayd-raqam=\"#s-video\"></span>. С учётом накладных расходов VPN и TLS хватает пакета на 5–6 ГБ. Безлимит не обязателен.</p><h4>Для закупки</h4><ul><li>Корпоративный договор с оператором: все SIM на одном счёте, месячный лимит и уведомления.</li><li>Если трафик превышает лимит, платформа показывает это по объекту: обычно виновата камера, которая даёт много событий из-за качающегося на ветру дерева.</li></ul>"
    }
  }
...
Object.assign(window.MKB_BATAFSIL, {
  ...
  "s-faq.nega": {
    ...
    tana: "<p>O'nta yechimning narxi bir obyekt uchun 3 mln so'mdan 100 mln so'mdan oshiqqacha. Qaysi obyektga qaysi biri mosligini qog'ozda aniq aytib bo'lmaydi: 4G signali, qishki quyosh, o'g'irlik xavfi va sotuv muddati har joyda boshqa.</p><h4>Pilot nimani o'lchaydi</h4><ul><li>Ishlash vaqti: qurilma necha foiz vaqt aloqada bo'ldi.</li><li>Avtonomlik: akkumulyator eng past zaryadi va qishdagi uzilishlar.</li><li>Yolg'on signallar soni va operator yuklamasi.</li><li>Oylik trafik va SIM xarajati.</li><li>Servis tashriflari soni.</li></ul><h4>Hisob</h4><p>Taxminiy hisob: 10 obyekt × 10–15 mln so'm = 100–150 mln so'm jihoz va montaj. SIM va olti haftalik servis bilan ko'pi bilan 200 mln so'm (<span data-slayd-raqam=\"#s-pilot\"></span>-slayd). Integratsiyani bankning o'z jamoasi qiladi. 267 obyektga birdan o'tilsa, xato yechim bir necha mlrd so'mlik xaridga aylanadi.</p><p class='ogoh'>Pilot 6 hafta davom etadi va qishni qamramasligi mumkin. Quyosh yechimlari bo'yicha yakuniy qaror birinchi dekabr-yanvar ma'lumotidan keyin tasdiqlanadi.</p>",
    manba: [],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "Пилот удерживает ошибку в бюджете 10 объектов",
      tana: "<p>Десять решений стоят от 3 млн до более чем 100 млн сумов за объект. Какое подходит какому объекту, на бумаге точно не сказать: 4G-сигнал, зимнее солнце, риск кражи и срок продажи везде разные.</p><h4>Что измеряет пилот</h4><ul><li>Время работы: какой процент времени устройство было на связи.</li><li>Автономность: минимальный заряд аккумулятора и отключения зимой.</li><li>Количество ложных сигналов и нагрузка на оператора.</li><li>Месячный трафик и расходы на SIM.</li><li>Количество сервисных выездов.</li></ul><h4>Расчёт</h4><p>Ориентировочно: 10 объектов × 10–15 млн сумов = 100–150 млн сумов на оборудование и монтаж. С SIM и шестью неделями сервиса — не более 200 млн сумов (слайд <span data-slayd-raqam=\"#s-pilot\"></span>). Интеграцию делает собственная команда банка. Если сразу перейти на 267 объектов, неверное решение превратится в закупку на несколько млрд сумов.</p><p class='ogoh'>Пилот длится 6 недель и может не захватить зиму. По солнечным решениям окончательное решение утверждается после первых данных за декабрь-январь.</p>"
    }
  },
  ...
  "s-faq.trafik": {
    ...
    tana: "<p>Doimiy oqim 4G kamerani ham, SIM byudjetini ham tez tugatadi. Hodisaga asoslangan tizimda trafik to'rt qismdan iborat. Farazlar <span data-slayd-raqam=\"#s-video\"></span>-slayddagi video hisobi bilan bir xil, haqiqiy raqamni pilot beradi.</p><table><tr><th>Qism</th><th>Faraz</th><th>Oyiga</th></tr><tr><td>Holat signali</td><td>har 60 s, ~0,5 KB</td><td class='n'>~22 MB</td></tr><tr><td>Hodisa kadri</td><td>30 ta/kun × 200 KB</td><td class='n'>~180 MB</td></tr><tr><td>Klip</td><td>10 ta/kun × 2 MB</td><td class='n'>~600 MB</td></tr><tr><td>Jonli ko'rish</td><td>30 daq/kun × 512 kbit/s</td><td class='n'>~3,5 GB</td></tr><tr><td><b>Jami</b></td><td></td><td class='n'>~4,3 GB</td></tr></table><h4>Nimani boshqaramiz</h4><ul><li>Jonli sessiya 60 soniyalik token bilan ochiladi va o'zi yopiladi.</li><li>Klip uzunligi va bitreyt obyekt profilida sozlanadi.</li><li>Oylik limitning 80% iga yetganda platforma ogohlantiradi.</li></ul><p>Jonli video ochilmasa, oyiga 0,8 GB bilan eng kichik paket yetadi. Yopiq APN bilan korporativ tarif operator bilan markazdan kelishiladi. <span data-slayd-raqam=\"#s-iqtisod\"></span>-slayddagi hisobda SIM va trafik uchun obyektga yiliga 1,2 mln so'm qo'yilgan.</p><p class='ogoh'>Shamol, hayvon yoki daraxt soyasi yolg'on harakat hodisasini ko'paytiradi. Detektor zonasi montajda sozlanmasa, trafik ikki-uch barobar oshadi.</p>",
    manba: [],
    ru: {
      yorliq: "Для тимлида",
      sarlavha: "Трафик: 0,8–4,3 ГБ на камеру в месяц",
      tana: "<p>Постоянный поток быстро съедает и 4G-камеру, и бюджет SIM. В системе на событиях трафик складывается из четырёх частей. Допущения те же, что в расчёте видео на слайде <span data-slayd-raqam=\"#s-video\"></span>, реальные цифры даст пилот.</p><table><tr><th>Часть</th><th>Допущение</th><th>В месяц</th></tr><tr><td>Сигнал состояния</td><td>каждые 60 с, ~0,5 КБ</td><td class='n'>~22 МБ</td></tr><tr><td>Кадр события</td><td>30 в день × 200 КБ</td><td class='n'>~180 МБ</td></tr><tr><td>Клип</td><td>10 в день × 2 МБ</td><td class='n'>~600 МБ</td></tr><tr><td>Живой просмотр</td><td>30 мин в день × 512 кбит/с</td><td class='n'>~3,5 ГБ</td></tr><tr><td><b>Итого</b></td><td></td><td class='n'>~4,3 ГБ</td></tr></table><h4>Чем управляем</h4><ul><li>Живая сессия открывается токеном на 60 секунд и закрывается сама.</li><li>Длина клипа и битрейт задаются в профиле объекта.</li><li>При 80% месячного лимита платформа предупреждает.</li></ul><p>Если живое видео не открывать, 0,8 ГБ в месяц укладываются в самый малый пакет. Корпоративный тариф с закрытым APN согласуется с оператором централизованно. В расчёте на слайде <span data-slayd-raqam=\"#s-iqtisod\"></span> на SIM и трафик заложено 1,2 млн сумов в год на объект.</p><p class='ogoh'>Ветер, животные и тень деревьев умножают ложные события движения. Если зону детектора не настроить при монтаже, трафик вырастет в два-три раза.</p>"
    }
  },
  ...
  "s-faq.brend": {
    ...
    tana: "<p>Veb-panel va mobil ilova hech qachon kameraga to'g'ridan-to'g'ri murojaat qilmaydi. Ular faqat MKB API bilan ishlaydi. Shuning uchun yangi ishlab chiqaruvchi qo'shilganda o'zgaradigan yagona qism — adapter.</p><h4>Adapter nimani bajarishi shart</h4><ol><li>Hodisani yagona sxemaga o'tkazish: obyekt_id, qurilma_id, tur, vaqt UTC'da, kadr havolasi.</li><li>Holatni berish: batareya, signal, xotira, last_seen.</li><li>Buyruqni bajarish: eshik, PTZ, sirena. Natija jurnalga qaytadi.</li><li>Video manzilini media shlyuzga berish: RTSP yoki ONVIF profili.</li></ol><h4>Qabul testi</h4><ul><li>Shartnoma testlari: har xabar JSON Schema'dan o'tadi.</li><li>Yozib olingan haqiqiy hodisalarda qurilmasiz sinov.</li><li>Pilotda bir hafta: hodisa yo'qolmaydi, takror hodisa bitta yozuvga birlashadi.</li></ul><p>Taxminiy mehnat: hujjatlashgan API'li brend uchun 1–4 hafta, brendlar bo'yicha baho <span data-slayd-raqam=\"#s-adapter\"></span>-slaydda. API yopiq bo'lsa, faqat ONVIF va RTSP darajasida ulanadi va hodisalar cheklangan bo'ladi.</p><p class='ogoh'>Tenderda ishlab chiqaruvchidan ochiq API hujjati va sinov qurilmasi talab qilinadi. Hujjat bermagan brend ro'yxatga kirmaydi.</p>",
    manba: [],
    ru: {
      yorliq: "Для тимлида",
      sarlavha: "Новый бренд — это просто новый адаптер",
      tana: "<p>Веб-панель и мобильное приложение никогда не обращаются к камере напрямую. Они работают только с MKB API. Поэтому при подключении нового производителя меняется одна часть — адаптер.</p><h4>Что обязан делать адаптер</h4><ol><li>Переводить событие в единую схему: объект_id, устройство_id, тип, время в UTC, ссылка на кадр.</li><li>Отдавать состояние: батарея, сигнал, память, last_seen.</li><li>Выполнять команды: дверь, PTZ, сирена. Результат возвращается в журнал.</li><li>Передавать адрес видео медиашлюзу: RTSP или профиль ONVIF.</li></ol><h4>Приёмочный тест</h4><ul><li>Контрактные тесты: каждое сообщение проходит JSON Schema.</li><li>Прогон на записанных реальных событиях без устройства.</li><li>Неделя на пилоте: события не теряются, повторы склеиваются в одну запись.</li></ul><p>Ориентировочная трудоёмкость — 1–4 недели для бренда с документированным API, оценки по брендам на слайде <span data-slayd-raqam=\"#s-adapter\"></span>. Если API закрыт, подключение идёт только на уровне ONVIF и RTSP, события будут ограничены.</p><p class='ogoh'>В тендере от производителя требуют открытую документацию API и тестовое устройство. Бренд без документации в список не попадает.</p>"
    }
  },
...
Object.assign(window.MKB_BATAFSIL = window.MKB_BATAFSIL || {}, {
  ...
  "s-muammo.yozuv1": {
    yorliq: "Moliya uchun",
    sarlavha: "Balansdagi vaqt qancha turadi",
    tana: "<p>Sanoq balansga qabul kunidan boshlanadi va uni to'xtatib bo'lmaydi: aktiv sotilmasa, xarajat har oy ortaveradi.</p><table><tr><th>Muddat</th><th>Nima bo'ladi</th></tr><tr><td>Qabul kuni</td><td>Muddat sanog'i boshlanadi, aktiv reyestrga tushadi</td></tr><tr><td>6 oy</td><td>Mol-mulk va yer solig'i imtiyozi tugaydi; imtiyoz faqat binoli aktivga tegishli</td></tr><tr><td>12 oy</td><td>Aktiv «umidsiz» toifaga o'tadi: Markaziy bank 2696-son nizomi, 20-band — 100% zaxira</td></tr></table><h4>Shu vaqt ichida to'xtamaydigan xarajat</h4><ul><li>Soliq va kommunal to'lov.</li><li>Sug'urta polisi: summa baholangan qiymatdan kam bo'lmasligi kerak.</li><li>Qo'riqlash shartnomasi va servis.</li><li>Ko'rik safarlari: uzoq obyektga bitta safar bir ish kunini oladi.</li></ul><p>Misol uchun, 800 mln so'mlik obyekt 12 oyda sotilmasa, zaxira talabi 800 mln so'mga yetadi — o'sha obyektga qo'yiladigan 10 mln so'mlik nazorat komplektidan 80 barobar katta.</p><p class='ogoh'>Kamera qoidasi — bo'sh yer uchastkasidan tashqari har obyektda — jihoz tanlash sharti sifatida <a data-slayd='#s-shart' href='#'>«Tanlash mezoni» slaydida</a>, 02-shartda turadi.</p>",
    manba: [],
    ru: {
      yorliq: "Для финансов",
      sarlavha: "Сколько стоит время на балансе",
      tana: "<p>Отсчёт начинается в день приёма на баланс, и остановить его нельзя: пока актив не продан, расходы растут каждый месяц.</p><table><tr><th>Срок</th><th>Что происходит</th></tr><tr><td>День приёма</td><td>Начинается отсчёт сроков, актив попадает в реестр</td></tr><tr><td>6 месяцев</td><td>Заканчивается льгота по налогу на имущество и землю; она действует только для активов со зданием</td></tr><tr><td>12 месяцев</td><td>Актив переходит в «безнадёжную» категорию: положение Центрального банка № 2696, пункт 20 — резерв 100%</td></tr></table><h4>Расходы, которые в это время не прекращаются</h4><ul><li>Налог и коммунальные платежи.</li><li>Страховой полис: сумма не ниже оценочной стоимости.</li><li>Договор охраны и сервис.</li><li>Выезды на осмотр: один выезд на удалённый объект занимает рабочий день.</li></ul><p>Например, если объект за 800 млн сумов не продан за 12 месяцев, требование к резерву доходит до 800 млн — это в 80 раз больше комплекта контроля за 10 млн, который ставится на тот же объект.</p><p class='ogoh'>Правило про камеру — на каждом объекте, кроме пустого земельного участка — стоит условием выбора оборудования на <a data-slayd='#s-shart' href='#'>слайде «Критерии выбора»</a>, условие 02.</p>"
    }
  },
  ...
  "s-pilot.pilot5": {
    ...
    tana: "<p>Oxirgi hafta pilot natijasini 267 obyektga ko'chiriladigan uchta hujjatga aylantiradi.</p><h4>Hujjatlar</h4><ul><li><b>Smeta:</b> har yechim uchun jihoz bo'yicha alohida narx, montaj, SIM va servis. Paket narxi emas.</li><li><b>SLA:</b> kritik nosozlikka kelish shaharda 4, tumanda 24, chekkada 48 soat (<span data-slayd-raqam=\"#s-qabul\"></span>-slayd), zaxira jihoz, jarima.</li><li><b>Joriy etish standarti:</b> obyekt turiga qarab yechim tanlash jadvali, ko'rik varag'i, qabul akti, qurilmani platformaga ulash tartibi.</li></ul><h4>Keyingi bosqich</h4><table><tr><th>Bosqich</th><th>Obyekt</th></tr><tr><td>Pilot, 1–6-hafta</td><td class='n'>10</td></tr><tr><td>1-bosqich: eng qimmat va xavfli, 2–4-oy</td><td class='n'>50 gacha</td></tr><tr><td>2-bosqich: butun balans, ko'char mulk bilan, 5–9-oy</td><td class='n'>267</td></tr><tr><td>3-bosqich: har yangi aktiv</td><td class='n'>10 ish kunida</td></tr></table><p>Obyekt soni yig'ma: jadval <span data-slayd-raqam=\"#s-yol\"></span>-slayddagi yo'l xaritasi bilan bir xil.</p><p>Hujjatlarni bank tomonidan loyiha rahbari, IT va xarid bo'limi birgalikda imzolaydi.</p><p class='ogoh'>Bosqichlar hajmi taxminiy va pilot natijasiga qarab o'zgaradi. Har bosqich oldidan kamida uchta tijorat taklifi olinadi.</p>",
    manba: [],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "Неделя 6: смета, SLA и стандарт внедрения",
      tana: "<p>Последняя неделя превращает итоги пилота в три документа, которые переносятся на 267 объектов.</p><h4>Документы</h4><ul><li><b>Смета:</b> по каждому решению — отдельная цена за единицу оборудования, монтаж, SIM и сервис. Не пакетная цена.</li><li><b>SLA:</b> выезд при критической неисправности — 4 часа в городе, 24 в районе, 48 на отдалённых объектах (слайд <span data-slayd-raqam=\"#s-qabul\"></span>), резервное оборудование, штрафы.</li><li><b>Стандарт внедрения:</b> таблица выбора решения по типу объекта, лист обследования, акт приёмки, порядок подключения устройства к платформе.</li></ul><h4>Следующий этап</h4><table><tr><th>Этап</th><th>Объектов</th></tr><tr><td>Пилот, недели 1–6</td><td class='n'>10</td></tr><tr><td>Этап 1: самые дорогие и рискованные, месяцы 2–4</td><td class='n'>до 50</td></tr><tr><td>Этап 2: весь баланс вместе с движимым имуществом, месяцы 5–9</td><td class='n'>267</td></tr><tr><td>Этап 3: каждый новый актив</td><td class='n'>за 10 раб. дней</td></tr></table><p>Число объектов нарастающим итогом: таблица совпадает с дорожной картой на слайде <span data-slayd-raqam=\"#s-yol\"></span>.</p><p>Документы со стороны банка совместно подписывают руководитель проекта, IT и отдел закупок.</p><p class='ogoh'>Объёмы этапов ориентировочные и зависят от итогов пилота. Перед каждым этапом собираются не менее трёх коммерческих предложений.</p>"
    }
  },
  "s-pilot.qaror1": {
    yorliq: "Rahbariyat uchun",
...
/* ---- yechimB ---- */
/* yechimB: 18–22 va 23-slaydlar (s-y06..s-y10, s-narx) uchun batafsil yozuvlar.
...
(function () {
  ...
  /* ---------- s-arx: ustunlar ichidagi qatorlar ---------- */
  ...
  /* ---------- s-shart: yechim qanday tanlanadi ---------- */
  B["s-matritsa.tanlov"] = {
    yorliq: "Rahbariyat uchun",
...
/* ---- muallif B: kirish bobi — 06 · Rollar, 07 · Ishlash sxemasi, 08 · Natija ---- */
Object.assign(window.MKB_BATAFSIL, {

  /* ===================== 06 · Rollar ===================== */
  "s-rol.rahbariyat": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Panel obyektlar ro'yxatini emas, qaror talab qiladiganlarni ko'rsatadi",
    tana: "<p>Panelda to'rtta blok turadi. Har birining ostida reyestr filtri bor: raqamni bosgan odam aniq obyektlar ro'yxatiga tushadi, jamlanma sonda qolib ketmaydi.</p><table><tr><th>Blok</th><th>Qayerdan hisoblanadi</th></tr><tr><td>Zaxira yuki, mln so'm</td><td>Aktiv toifasi va balans qiymati, Markaziy bankning 2696-son nizomi bo'yicha</td></tr><tr><td>«Umidsiz» toifagacha 90 kundan kam qolgan aktivlar</td><td>Balansga olingan sana va undan 365 kun</td></tr><tr><td>Nazoratsiz obyektlar</td><td>Qo'riqlash shartnomasi ham, ulangan qurilmasi ham yo'q obyektlar</td></tr><tr><td>Tasdiq kutayotgan qarorlar</td><td>Xarajat, lot narxi va oylik hisobotdan kelgan navbat</td></tr></table><h4>Nimani tasdiqlaydi</h4><ul><li>Limitdan oshgan xarajat: jihoz, montaj yoki servis.</li><li>Lot narxini pasaytirish taklifi.</li><li>Oylik hisobotni yopish.</li></ul><p>Rahbariyat eshik ocha olmaydi va yozuvni o'chira olmaydi: bu huquqlar boshqa rollarda. Panelda ochilgan har bir yozuv jurnalga tushadi.</p>",
    manba: [["MB 2696-son nizom, lex.uz", "https://lex.uz/mact/-2703053"]],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "Панель показывает не список объектов, а то, что требует решения",
      tana: "<p>На панели четыре блока. У каждого под цифрой стоит фильтр реестра: нажав на число, вы попадаете в конкретный список объектов, а не остаётесь со сводной цифрой.</p><table><tr><th>Блок</th><th>Откуда считается</th></tr><tr><td>Нагрузка резерва, млн сумов</td><td>Категория актива и балансовая стоимость по положению ЦБ № 2696</td></tr><tr><td>Активы, которым до «безнадёжных» осталось меньше 90 дней</td><td>Дата постановки на баланс и 365 дней от неё</td></tr><tr><td>Объекты без контроля</td><td>Нет ни договора охраны, ни подключённого устройства</td></tr><tr><td>Решения, ждущие утверждения</td><td>Очередь из расходов, цены лота и месячной отчётности</td></tr></table><h4>Что утверждает</h4><ul><li>Расход сверх лимита: оборудование, монтаж или сервис.</li><li>Предложение снизить цену лота.</li><li>Закрытие месячного отчёта.</li></ul><p>Руководство не может открыть дверь и не может удалить запись: эти права у других ролей. Каждая открытая на панели запись попадает в журнал.</p>"
    }
  },

  "s-rol.menejer": {
    yorliq: "Obyekt menejeri uchun",
    sarlavha: "Nazorat indeksi safarning o'rniga qo'yiladi",
    tana: "<p>Obyekt menejerining vaqti yo'lga ketadi: bugun obyekt holatini bilishning boshqa yo'li yo'q. Kartochkadagi nazorat indeksi shu savolga javob beradi — obyekt bo'yicha nima joyida va nima yetishmaydi.</p><h4>Indeks nimadan yig'iladi</h4><ul><li>Qurilma oxirgi marta aloqada bo'lgan vaqt va batareya zaxirasi.</li><li>Oxirgi ko'rik sanasi va navbatdagi ko'rikkacha qolgan kun.</li><li>Yopilmagan hodisalar va muddati o'tgan servis arizalari.</li><li>Sug'urta polisi, yong'in datchigi va hujjatlar to'plami.</li></ul><h4>Kartochkadan boshlanadigan amallar</h4><table><tr><th>Amal</th><th>Nima yaratadi</th></tr><tr><td>Servis arizasi</td><td>Pudratchiga topshiriq: muddat, javobgar, qabul sharti</td></tr><tr><td>Montaj topshirig'i</td><td>Jihoz ro'yxati, o'rnatish nuqtasi, qabul dalolatnomasi</td></tr><tr><td>Xarajat yozuvi</td><td>Obyekt bo'yicha xarajat kesimi; limitdan oshsa tasdiqqa boradi</td></tr></table><p class='ogoh'>Indeks og'irliklari pilotda sozlanadi. Birinchi oy real ma'lumot yig'iladi, chegara qiymatlari shundan keyin qo'yiladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для менеджера объекта",
      sarlavha: "Индекс контроля встаёт на место выезда",
      tana: "<p>Время менеджера объекта уходит на дорогу: другого способа узнать состояние объекта сегодня нет. Индекс контроля в карточке отвечает на этот вопрос — что по объекту в порядке, а чего не хватает.</p><h4>Из чего складывается индекс</h4><ul><li>Время последнего выхода устройства на связь и запас батареи.</li><li>Дата последнего осмотра и сколько дней до следующего.</li><li>Незакрытые события и просроченные сервисные заявки.</li><li>Страховой полис, пожарный датчик и комплект документов.</li></ul><h4>Действия, которые начинаются из карточки</h4><table><tr><th>Действие</th><th>Что создаёт</th></tr><tr><td>Сервисная заявка</td><td>Задание подрядчику: срок, ответственный, условие приёмки</td></tr><tr><td>Задание на монтаж</td><td>Список оборудования, точка установки, акт приёмки</td></tr><tr><td>Запись расхода</td><td>Разрез расходов по объекту; сверх лимита уходит на утверждение</td></tr></table><p class='ogoh'>Веса индекса настраиваются в пилоте. Первый месяц собираются реальные данные, пороговые значения ставятся после этого.</p>"
    }
  },

  "s-rol.inspektor": {
    yorliq: "Ko'rik inspektori uchun",
    sarlavha: "Masofaviy ko'rik joyidagi ko'rikni to'liq almashtirmaydi",
    tana: "<p>Inspektorning yuki safarlar sonidan kelib chiqadi. Kamerali obyektda ko'rikning bir qismini masofadan bajarsa bo'ladi, hammasini emas — buni ochiq aytish kerak.</p><table><tr><th>Ko'rik bandi</th><th>Masofadan</th></tr><tr><td>Bino butunligi, eshik va deraza</td><td>Ha, kadr va klip bilan</td></tr><tr><td>Ichkarida buzilish yoki o'g'irlik izi</td><td>Ha, kamera ichkarida bo'lsa</td></tr><tr><td>Tom qoplamasi, zax, suv oqishi</td><td>Yo'q, joyida ko'rish kerak</td></tr><tr><td>Hisoblagich ko'rsatkichi, hujjat imzosi</td><td>Yo'q</td></tr></table><h4>Tizimda nima o'zgaradi</h4><ul><li>Ko'rik rejasi kalendarda: kim, qaysi obyekt, qaysi sana.</li><li>Dalolatnoma joyida to'ldiriladi — surat va koordinata bilan.</li><li>Muddati o'tgan ko'riklar alohida ro'yxatda: inspektorda ham, uning rahbarida ham.</li><li>Masofaviy ko'rik alohida turdagi yozuv: qaysi kadrlar asosida bajarilgani saqlanadi.</li></ul><p class='ogoh'>Masofaviy ko'rikni qaysi hollarda joyidagi ko'rik o'rniga hisobga olish mumkinligi bankning ichki ko'rik qoidasiga kiritilishi kerak. Bu huquqiy qaror, texnik emas.</p>",
    manba: [],
    ru: {
      yorliq: "Для инспектора по осмотрам",
      sarlavha: "Удалённый осмотр не заменяет выездной полностью",
      tana: "<p>Нагрузка инспектора измеряется числом выездов. На объекте с камерой часть осмотра можно сделать удалённо, но не весь — об этом стоит сказать прямо.</p><table><tr><th>Пункт осмотра</th><th>Удалённо</th></tr><tr><td>Целость здания, двери и окна</td><td>Да, по кадру и клипу</td></tr><tr><td>Следы взлома или хищения внутри</td><td>Да, если камера стоит внутри</td></tr><tr><td>Кровля, сырость, протечки</td><td>Нет, нужен выезд</td></tr><tr><td>Показания счётчика, подпись на документе</td><td>Нет</td></tr></table><h4>Что меняется в системе</h4><ul><li>План осмотров в календаре: кто, какой объект, какая дата.</li><li>Акт заполняется на месте — с фото и координатой.</li><li>Просроченные осмотры в отдельном списке: и у инспектора, и у его руководителя.</li><li>Удалённый осмотр — запись отдельного типа: сохраняется, на каких кадрах он сделан.</li></ul><p class='ogoh'>В каких случаях удалённый осмотр засчитывается вместо выездного, нужно закрепить во внутреннем регламенте осмотров банка. Это юридическое решение, а не техническое.</p>"
    }
  },

  "s-rol.xavfsizlik": {
    yorliq: "Xavfsizlik xizmati uchun",
    sarlavha: "Navbatchining ekrani video devori emas, hodisalar navbati",
    tana: "<p>Navbatchi yuzta jonli oqimga qaramaydi: ekranda faqat kelgan hodisalar turadi. Signal bo'lmasa, ekranda ish ham bo'lmaydi.</p><h4>Navbatdagi bitta qator</h4><ul><li>Obyekt nomi, hodisa turi, vaqti va kadr.</li><li>«Ko'rish» — o'sha kameraning oqimi talab bo'yicha yoqiladi, doimiy emas.</li><li>Buyruqlar: sirena, eshik, yorug'lik. Har biri kim bergani bilan jurnalga yoziladi.</li><li>Yakun: tasdiqlandi yoki yolg'on signal, sababi bilan.</li></ul><h4>Nima qila olmaydi</h4><ul><li>Obyektning balans qiymatini ko'ra olmaydi.</li><li>Arxivdagi yozuvni o'chira olmaydi: fayl o'zgartirib bo'lmaydigan omborda yotadi.</li></ul><p>Jismoniy javobni bank bermaydi. O'RQ-778 bo'yicha shartnoma asosida qo'riqlashni faqat davlat organi ko'rsatadi, shuning uchun tasdiqlangan signal IIV huzuridagi Qo'riqlash departamenti pultiga yoki 102 ga uzatiladi.</p><p class='ogoh'>Yolg'on signallar ulushi pilotda o'lchanadi. Aynan shu raqam bitta smenadagi operator sonini belgilaydi.</p>",
    manba: [["O'RQ-778, lex.uz", "https://lex.uz/docs/-6066682"]],
    ru: {
      yorliq: "Для службы безопасности",
      sarlavha: "Экран дежурного — не видеостена, а очередь событий",
      tana: "<p>Дежурный не смотрит на сотню живых потоков: на экране только пришедшие события. Нет сигнала — нет и работы на экране.</p><h4>Одна строка очереди</h4><ul><li>Название объекта, тип события, время и кадр.</li><li>«Смотреть» — поток нужной камеры включается по запросу, а не постоянно.</li><li>Команды: сирена, дверь, свет. Каждая пишется в журнал с именем того, кто её отдал.</li><li>Итог: подтверждено или ложный сигнал, с указанием причины.</li></ul><h4>Чего не может</h4><ul><li>Не видит балансовую стоимость объекта.</li><li>Не может удалить запись из архива: файл лежит в неизменяемом хранилище.</li></ul><p>Физическое реагирование банк не обеспечивает. По ЗРУ-778 охрану по договору оказывает только государственный орган, поэтому подтверждённый сигнал уходит на пульт Департамента охраны при МВД или на 102.</p><p class='ogoh'>Доля ложных сигналов измеряется в пилоте. Именно эта цифра определяет число операторов в смене.</p>"
    }
  },

  "s-rol.risk": {
    yorliq: "Buxgalteriya va risk uchun",
    sarlavha: "Toifa qo'lda emas, balansga olingan sanadan hisoblanadi",
    tana: "<p>Bugun toifani belgilash uchun balans ma'lumoti va mulk ro'yxati qo'lda solishtiriladi. Xatoning narxi katta: bitta obyektning toifasi noto'g'ri bo'lsa, zaxira summasi ham noto'g'ri chiqadi.</p><h4>Tizimda qanday bo'ladi</h4><ul><li>Har obyektda balansga olingan sana va o'sha kundan beri o'tgan kun turadi.</li><li>365 kun chegarasi avtomatik hisoblanadi va toifa taklif qilinadi; yakuniy belgilashni buxgalteriya bajaradi.</li><li>Markaziy bank uchun oylik hisobot shu bazadan yig'iladi — qo'lda ko'chirish yo'q.</li><li>Xarajat obyekt bo'yicha kesiladi: jihoz, montaj, SIM, servis, kommunal.</li></ul><h4>Risk uchun ikkinchi kesim</h4><p>Nazorat qamrovi: qaysi obyektlarda na qo'riqlash shartnomasi, na ishlab turgan qurilma bor. Bu ro'yxat operatsion xatarning bevosita o'lchovi va u har kuni yangilanadi.</p><p class='ogoh'>Markaziy bank 2026-yil 10-sentabrda 3937-son yangi tasniflash va zaxira nizomini ro'yxatdan o'tkazdi. Bir yillik qoida o'zgarmaganini bank yuristlari tasdiqlashi kerak.</p>",
    manba: [["MB 2696-son nizom, lex.uz", "https://lex.uz/mact/-2703053"]],
    ru: {
      yorliq: "Для бухгалтерии и риска",
      sarlavha: "Категория считается не вручную, а от даты постановки на баланс",
      tana: "<p>Сегодня, чтобы определить категорию, балансовые данные и список имущества сверяют вручную. Цена ошибки высокая: неверная категория по одному объекту — неверная сумма резерва.</p><h4>Как будет в системе</h4><ul><li>По каждому объекту видны дата постановки на баланс и число дней с этой даты.</li><li>Порог в 365 дней считается автоматически, категория предлагается; окончательно её ставит бухгалтерия.</li><li>Месячный отчёт для ЦБ собирается из этой же базы — переносить вручную не нужно.</li><li>Расходы режутся по объекту: оборудование, монтаж, SIM, сервис, коммунальные.</li></ul><h4>Второй разрез для риска</h4><p>Охват контролем: на каких объектах нет ни договора охраны, ни работающего устройства. Этот список — прямая мера операционного риска, и он обновляется ежедневно.</p><p class='ogoh'>10 сентября 2026 года ЦБ зарегистрировал новое положение № 3937 о классификации активов и резервах. Что правило одного года не изменилось, должны подтвердить юристы банка.</p>"
    }
  },

  "s-rol.realizatsiya": {
    yorliq: "Realizatsiya uchun",
    sarlavha: "E'longa odam tushgan kadr chiqmaydi",
    tana: "<p>Realizatsiya mutaxassisiga hodisalar navbati ham, jonli video ham berilmaydi. Unga faqat e'londa ishlatsa bo'ladigan material ochiladi.</p><h4>Lot kartasida nima bor</h4><ul><li>Shu haftada olingan kadrlar to'plami va qisqa video.</li><li>Tashriflar jurnali: kim, qachon kelgan, necha daqiqa qolgan.</li><li>Takliflar va ularning sanasi.</li><li>Balansda necha kun turgani va «umidsiz» toifagacha qolgan muddat.</li></ul><h4>Cheklov</h4><ul><li>Kadrda odam bo'lsa, u e'longa qo'yilmaydi — bu shaxsga doir ma'lumot.</li><li>Kadrni e'longa chiqarish alohida amal bo'lib jurnalga tushadi: kim, qachon, qaysi fayl.</li></ul><p>Rolning o'lchovi bitta: e'londan shartnomagacha o'tgan kun. Uni obyekt turi bo'yicha mediana bilan solishtiriladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для реализации",
      sarlavha: "Кадр с человеком в объявление не попадает",
      tana: "<p>Специалисту по реализации не дают ни очередь событий, ни живое видео. Ему открывается только материал, пригодный для объявления.</p><h4>Что есть в карточке лота</h4><ul><li>Набор кадров этой недели и короткое видео.</li><li>Журнал визитов: кто, когда приехал, сколько пробыл.</li><li>Предложения и их даты.</li><li>Сколько дней объект на балансе и сколько осталось до категории «безнадёжный».</li></ul><h4>Ограничение</h4><ul><li>Если в кадре человек, кадр в объявление не ставится — это персональные данные.</li><li>Публикация кадра — отдельное действие, оно пишется в журнал: кто, когда, какой файл.</li></ul><p>Показатель у роли один: число дней от объявления до договора. Его сравнивают с медианой по типу объекта.</p>"
    }
  },

  "s-rol.ad": {
    yorliq: "Administrator uchun",
    sarlavha: "Kirish bank AD hisobi bilan, ikkinchi omil buyruq beradiganlarga",
    tana: "<p>Tizimda alohida foydalanuvchi bazasi yo'q. Kirish bankning Active Directory hisobi orqali amalga oshadi, rol esa AD guruhidan olinadi.</p><h4>Nimani anglatadi</h4><ul><li>Yangi parol yaratilmaydi va alohida parol siyosati yuritilmaydi.</li><li>Xodim boshqa bo'limga o'tsa yoki ishdan bo'shasa, AD dagi o'zgarish ertasiga tizimda aks etadi.</li><li>Buyruq beradigan rollar — xavfsizlik xizmati va administrator — uchun ikkinchi omil talab qilinadi.</li><li>Sessiya sakkiz soatdan keyin tugaydi, qayta kirish so'raladi.</li></ul><h4>Audit</h4><p>Har bir ko'rish va har bir buyruq jurnalga tushadi va besh yil saqlanadi. Jurnalni administratorning o'zi ham tahrirlay olmaydi: yozuv faqat qo'shiladi, o'chirilmaydi.</p><p class='ogoh'>AD guruhlari nomlari va ularning rollarga mosligi bank axborot texnologiyalari bo'limi bilan pilotdan oldin kelishiladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для администратора",
      sarlavha: "Вход по учётной записи AD банка, второй фактор — для тех, кто отдаёт команды",
      tana: "<p>Отдельной базы пользователей в системе нет. Вход выполняется через учётную запись Active Directory банка, а роль берётся из группы AD.</p><h4>Что это значит</h4><ul><li>Новый пароль не создаётся, отдельная парольная политика не ведётся.</li><li>Если сотрудник перешёл в другое подразделение или уволился, изменение в AD отражается в системе на следующий день.</li><li>Для ролей, отдающих команды — служба безопасности и администратор, — требуется второй фактор.</li><li>Сессия завершается через восемь часов, вход запрашивается заново.</li></ul><h4>Аудит</h4><p>Каждый просмотр и каждая команда попадают в журнал и хранятся пять лет. Журнал не может править и сам администратор: запись только добавляется, но не удаляется.</p><p class='ogoh'>Названия групп AD и их соответствие ролям согласуются с управлением информационных технологий банка до пилота.</p>"
    }
  },
  ...
  "s-sxema.misol": {
    yorliq: "Izoh",
    sarlavha: "Misol shartli, mexanizm haqiqiy",
    tana: "<p>Qarshi tumanidagi ombor va 03:12 vaqti — taqdimot uchun tanlangan shartli holat. Uning ortidagi har bir bo'g'in esa mavjud jihoz va mavjud platformaning ishlash tartibi.</p><h4>Nega aynan dekabr kechasi</h4><ul><li>Dekabr — quyosh eng kam beradigan oy: Toshkentda kuniga 1,62 kVt·soat/m², iyunda 7,60. Komplekt shu oyga hisoblanadi.</li><li>Tun — obyekt eng zaif payt: keyingi ko'rikkacha u yerga hech kim bormaydi.</li><li>Ombor — balansdagi 12 ta omborxonadan biri, elektri ham, aloqasi ham uzilgan.</li></ul><p>Shu uch shart birga kelganda zanjirning har bo'g'ini sinovdan o'tadi: quvvat zaxirasi, joyidagi yozuv, bufer, yopiq kanal va qoidalar mexanizmi.</p><p class='ogoh'>Vaqt belgilari aloqa ishlab turgan holatga tegishli. Aloqa uzilgan bo'lsa, 01 va 02 o'zgarmaydi, markazga yetishi esa kanal tiklangandan keyin 15 daqiqa ichida bo'ladi.</p>",
    manba: [],
    ru: {
      yorliq: "Пояснение",
      sarlavha: "Пример условный, механизм настоящий",
      tana: "<p>Склад в Каршинском районе и время 03:12 — условная ситуация, выбранная для презентации. А каждое звено за ней — порядок работы реального оборудования и реальной платформы.</p><h4>Почему именно декабрьская ночь</h4><ul><li>Декабрь — месяц с минимумом солнца: в Ташкенте 1,62 кВт·ч/м² в сутки против 7,60 в июне. Комплект считается именно на этот месяц.</li><li>Ночь — самое уязвимое время: до следующего осмотра туда никто не приедет.</li><li>Склад — один из 12 складов на балансе, без электричества и без связи.</li></ul><p>Когда эти три условия сходятся, проверку проходит каждое звено цепочки: запас питания, запись на месте, буфер, закрытый канал и механизм правил.</p><p class='ogoh'>Отметки времени относятся к случаю, когда связь работает. При обрыве связи звенья 01 и 02 не меняются, а до центра запись доходит в течение 15 минут после восстановления канала.</p>"
    }
  },

  "s-sxema.yozuv": {
    yorliq: "Texnik izoh",
    sarlavha: "Dalil avval joyida yoziladi, keyin yuboriladi",
    tana: "<p>Ko'p tizimda xato bitta joyda bo'ladi: hodisa markazga yetgandan keyingina hisobga olinadi. Aloqa uzilgan bo'lsa, hodisa umuman qolmaydi. Bu yerda tartib teskari.</p><ol><li>Datchik yoki kamera qo'zg'alishni qayd etadi.</li><li>Kadr va qisqa klip qurilmaning o'zida — microSD, NVR yoki hub xotirasida — yoziladi.</li><li>Shundan keyingina yuborish urinishi boshlanadi.</li></ol><h4>Qaysi qurilma qayerga yozadi</h4><table><tr><th>Qurilma</th><th>Joyidagi yozuv</th></tr><tr><td>Quyosh-4G kamera</td><td>microSD, odatda 64–128 GB</td></tr><tr><td>Korporativ IP kamera</td><td>NVR diski</td></tr><tr><td>Ajax datchiklari</td><td>Hub xotirasi, kadr bilan</td></tr><tr><td>LoRaWAN datchik</td><td>Faqat hodisa yozuvi, video yo'q</td></tr></table><p class='ogoh'>Joyidagi xotira cheklangan: eski yozuv ustiga yoziladi. Shuning uchun uzilish uzoq davom etsa, markazga avval hodisa metama'lumoti va kadr yuboriladi, to'liq klip keyin.</p>",
    manba: [],
    ru: {
      yorliq: "Техническая справка",
      sarlavha: "Доказательство сначала пишется на месте и только потом отправляется",
      tana: "<p>Во многих системах ошибка в одном месте: событие считается зафиксированным только после того, как дошло до центра. Оборвалась связь — события не было вовсе. Здесь порядок обратный.</p><ol><li>Датчик или камера фиксирует движение.</li><li>Кадр и короткий клип пишутся на самом устройстве — на microSD, диск NVR или в память хаба.</li><li>И только после этого начинается попытка отправки.</li></ol><h4>Какое устройство куда пишет</h4><table><tr><th>Устройство</th><th>Запись на месте</th></tr><tr><td>Солнечная 4G-камера</td><td>microSD, обычно 64–128 ГБ</td></tr><tr><td>Корпоративная IP-камера</td><td>Диск NVR</td></tr><tr><td>Датчики Ajax</td><td>Память хаба, вместе с кадром</td></tr><tr><td>Датчик LoRaWAN</td><td>Только запись события, видео нет</td></tr></table><p class='ogoh'>Память на месте ограничена: старая запись перетирается новой. Поэтому при долгом обрыве в центр сначала уходят метаданные события и кадр, а полный клип — позже.</p>"
    }
  },

  "s-sxema.quvvat": {
    yorliq: "Texnik izoh",
    sarlavha: "Bufer: 15 daqiqa nimadan kelib chiqqan",
    tana: "<p>Aloqa tiklanganda qurilma navbatdagi hammasini birdaniga yubormaydi: kanal tor, batareya cheklangan. Shuning uchun yuborish tartibi oldindan belgilanadi.</p><h4>Yuborish tartibi</h4><ol><li>Hodisa metama'lumoti: vaqt, tur, qurilma, obyekt. Bir necha kilobayt.</li><li>Kadr: bir necha yuz kilobayt.</li><li>Klip: talab bo'yicha yoki navbat bo'shaganda.</li></ol><p>15 daqiqa — bufer ko'chirish uchun qabul qilingan maqsad qiymati va u servis shartnomasiga yoziladi. Uni ikki narsa belgilaydi: qurilmaning uyg'onish davri va kanal kengligi.</p><h4>Quvvat tomoni</h4><ul><li>Panel va akkumulyator dekabr quyoshiga hisoblanadi: Toshkentda kuniga 1,62 kVt·soat/m².</li><li>Akkumulyator LiFePO4, past harorat himoyali BMS bilan: 0 °C dan past haroratda zaryadlash bloklanadi.</li><li>Batareya foizi va harorat telemetriya sifatida markazga chiqadi, ogohlantirish chegarasi oldindan qo'yiladi.</li></ul><p class='ogoh'>Uzoq uzilishda birinchi bo'lib batareya tugaydi, xotira emas. Shuning uchun quvvat hisobi montajdan oldin, joyidagi ko'rik bosqichida bajariladi.</p>",
    manba: [],
    ru: {
      yorliq: "Техническая справка",
      sarlavha: "Буфер: откуда взялись 15 минут",
      tana: "<p>После восстановления связи устройство не отправляет всю очередь разом: канал узкий, батарея ограничена. Поэтому порядок отправки задаётся заранее.</p><h4>Порядок отправки</h4><ol><li>Метаданные события: время, тип, устройство, объект. Несколько килобайт.</li><li>Кадр: несколько сотен килобайт.</li><li>Клип: по запросу или когда очередь освободится.</li></ol><p>15 минут — принятое целевое значение на выгрузку буфера, и оно вносится в сервисный договор. Его определяют две вещи: период пробуждения устройства и ширина канала.</p><h4>Сторона питания</h4><ul><li>Панель и аккумулятор считаются на декабрьское солнце: 1,62 кВт·ч/м² в сутки в Ташкенте.</li><li>Аккумулятор LiFePO4 с BMS и защитой от низкой температуры: заряд ниже 0 °C блокируется.</li><li>Процент заряда и температура уходят в центр телеметрией, порог предупреждения задаётся заранее.</li></ul><p class='ogoh'>При долгом обрыве первой заканчивается батарея, а не память. Поэтому расчёт питания делается до монтажа, на этапе выездного обследования.</p>"
    }
  },

  "s-sxema.kanal": {
    yorliq: "Texnik izoh",
    sarlavha: "Kamera bank tarmog'iga ochiq eshik bo'lib qolmasligi uchun",
    tana: "<p>Obyektdagi qurilma bank konturiga kiradi, ya'ni u tarmoq nuqtasi. Shuning uchun kanal ochiq internet orqali emas, yopiq yo'l bilan quriladi.</p><h4>Kanal qanday yopiladi</h4><ul><li>Operatorning yopiq APN'i yoki IPsec, SSL VPN: qurilma ommaviy internetda ko'rinmaydi.</li><li>Tashqaridan ulanish uchun port ochilmaydi — bog'lanishni doim qurilmaning o'zi boshlaydi.</li><li>TLS ichida: hodisa MQTT yoki webhook bilan, signal DC-09 bilan ketadi.</li><li>Zavod paroli montaj kuni almashtiriladi, mikrodastur versiyasi reyestrda yuritiladi.</li></ul><h4>Holat nazorati</h4><p>Har qurilma bo'yicha oxirgi aloqa vaqti, signal darajasi va mikrodastur versiyasi saqlanadi. Qurilma belgilangan vaqt ichida ko'rinmasa, «Aloqa yo'q» ogohlantirishi chiqadi — bu ham hodisa va u ham jurnalga tushadi.</p><p class='ogoh'>Yopiq APN va statik IP operator tarifiga kiradi: Uzmobile VPN paketi 3 GB uchun oyiga 28 800 so'm, Beeline «Doimiy IP» — 25 260 so'm.</p>",
    manba: [],
    ru: {
      yorliq: "Техническая справка",
      sarlavha: "Чтобы камера не стала открытой дверью в сеть банка",
      tana: "<p>Устройство на объекте входит в контур банка, то есть это сетевая точка. Поэтому канал строится не через открытый интернет, а закрытым путём.</p><h4>Как закрывается канал</h4><ul><li>Закрытый APN оператора либо IPsec, SSL VPN: устройство не видно в публичном интернете.</li><li>Порт для входящих подключений не открывается — соединение всегда инициирует само устройство.</li><li>Внутри TLS: событие уходит по MQTT или webhook, сигнал — по DC-09.</li><li>Заводской пароль меняется в день монтажа, версия прошивки ведётся в реестре.</li></ul><h4>Контроль состояния</h4><p>По каждому устройству хранятся время последней связи, уровень сигнала и версия прошивки. Если устройство не появлялось дольше заданного времени, поднимается предупреждение «Нет связи» — это тоже событие, и оно тоже попадает в журнал.</p><p class='ogoh'>Закрытый APN и статический IP входят в тариф оператора: пакет Uzmobile VPN на 3 ГБ — 28 800 сумов в месяц, Beeline «Постоянный IP» — 25 260 сумов.</p>"
    }
  },

  "s-sxema.qoida": {
    yorliq: "Jamoa rahbarlari uchun",
    sarlavha: "Bitta hodisa, uch xil manzil",
    tana: "<p>Hodisa kelgandan keyin savol bitta bo'ladi: kimni, qaysi kanal bilan va qancha vaqtda xabardor qilish kerak. Buni operator emas, oldindan yozilgan qoida hal qiladi.</p><h4>Qoida nimaga qaraydi</h4><ul><li>Hodisa turi: harakat, eshik, tutun, buzish, batareya past, aloqa yo'q.</li><li>Vaqt: ish vaqti yoki tun.</li><li>Obyekt: turi, qiymati, sotuvda ekani.</li><li>Takrorlanish: bir soat ichida nechanchi signal.</li></ul><h4>Shu misolda</h4><table><tr><th>Kim</th><th>Kanal</th><th>Nima uchun</th></tr><tr><td>Navbatchi</td><td>Ekrandagi navbat va tovush</td><td>Tunda harakat — darhol tekshirish kerak</td></tr><tr><td>Obyekt menejeri</td><td>Xabarnoma, ertalab topshiriq</td><td>Obyektga javobgar</td></tr><tr><td>Realizatsiya mutaxassisi</td><td>Xabar bormaydi</td><td>Unga odam tushgan kadr berilmaydi</td></tr></table><p class='ogoh'>Qoida o'zgartirilsa, kim va qachon o'zgartirgani jurnalga yoziladi. Qoidalarni administrator sozlaydi, tasdiqni xavfsizlik xizmati beradi.</p>",
    manba: [],
    ru: {
      yorliq: "Для тимлидов",
      sarlavha: "Одно событие, три разных адресата",
      tana: "<p>После поступления события вопрос один: кого, по какому каналу и за какое время уведомить. Решает это не оператор, а заранее записанное правило.</p><h4>На что смотрит правило</h4><ul><li>Тип события: движение, дверь, дым, взлом, низкий заряд, нет связи.</li><li>Время: рабочие часы или ночь.</li><li>Объект: тип, стоимость, находится ли в продаже.</li><li>Повторяемость: какой это сигнал за час.</li></ul><h4>В этом примере</h4><table><tr><th>Кто</th><th>Канал</th><th>Почему</th></tr><tr><td>Дежурный</td><td>Очередь на экране и звук</td><td>Движение ночью — проверить немедленно</td></tr><tr><td>Менеджер объекта</td><td>Уведомление, утром задание</td><td>Отвечает за объект</td></tr><tr><td>Специалист по реализации</td><td>Уведомление не уходит</td><td>Кадр с человеком ему не выдаётся</td></tr></table><p class='ogoh'>Если правило изменили, в журнал пишется, кто и когда это сделал. Правила настраивает администратор, утверждает служба безопасности.</p>"
    }
  },

  "s-sxema.jurnal": {
    yorliq: "Moliya va huquq",
    sarlavha: "Har bir ko'rish va buyruq besh yil saqlanadi",
    tana: "<p>Zanjirning oxiri qaror emas, yozuv. Hodisa yopilgandan keyin ham uning butun tarixi qoladi: kim ko'rdi, kim buyruq berdi, qaysi fayl asosida.</p><h4>Jurnalda nima bo'ladi</h4><ul><li>Hodisa: vaqt, tur, qurilma, obyekt, kadr va klip kaliti.</li><li>Ko'rish: kim, qachon, qaysi faylni ochdi.</li><li>Buyruq: eshik, sirena, PTZ — kim berdi va natija qanday bo'ldi.</li><li>Yakun: tasdiqlandi yoki yolg'on signal, izoh bilan.</li></ul><p>Klip o'zgartirib bo'lmaydigan omborga yoziladi, uning SHA-256 xeshi qabul paytida hisoblanadi. Eksportda manifest beriladi: qabul qiluvchi xeshni o'zi hisoblab solishtiradi.</p><h4>Oyning oxirida</h4><p>Shu jurnaldan uchta raqam chiqadi: hodisalar soni, yolg'on signal ulushi va javob vaqti. Ular oylik hisobotga va rahbariyat paneliga tushadi.</p><p class='ogoh'>Video saqlash muddati bankning ichki hujjatida belgilanadi: oddiy hodisa uchun 90 kun, nizoli hodisa uchun sud tugaguncha. Jurnal yozuvlari esa besh yil saqlanadi.</p>",
    manba: [],
    ru: {
      yorliq: "Финансы и право",
      sarlavha: "Каждый просмотр и каждая команда хранятся пять лет",
      tana: "<p>Конец цепочки — не решение, а запись. Даже после закрытия события остаётся вся его история: кто смотрел, кто отдавал команду, на основании какого файла.</p><h4>Что попадает в журнал</h4><ul><li>Событие: время, тип, устройство, объект, ключи кадра и клипа.</li><li>Просмотр: кто, когда, какой файл открыл.</li><li>Команда: дверь, сирена, PTZ — кто отдал и каким был результат.</li><li>Итог: подтверждено или ложный сигнал, с комментарием.</li></ul><p>Клип пишется в неизменяемое хранилище, его хеш SHA-256 считается в момент приёма. При экспорте прилагается манифест: получатель пересчитывает хеш сам и сверяет.</p><h4>В конце месяца</h4><p>Из этого журнала выходят три цифры: число событий, доля ложных сигналов и время реакции. Они попадают в месячный отчёт и на панель руководства.</p><p class='ogoh'>Срок хранения видео закрепляется во внутреннем документе банка: 90 дней для обычного события, до окончания суда — для спорного. Записи журнала хранятся пять лет.</p>"
    }
  },

  "s-sxema.qurilmasiz": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Qurilmasiz obyektda ham zanjir uzilmaydi",
    tana: "<p>267 obyektning hammasiga bir vaqtda jihoz o'rnatilmaydi. Platforma esa birinchi kundan barcha obyektlar bo'yicha ishlaydi: shunchaki birinchi uchta bo'g'inni odam to'ldiradi.</p><table><tr><th>Bo'g'in</th><th>Qurilma bor</th><th>Qurilma yo'q</th></tr><tr><td>01 Obyekt</td><td>Datchik va kamera</td><td>Rejadagi ko'rik</td></tr><tr><td>02 Komplekt</td><td>Joyidagi yozuv va bufer</td><td>Inspektorning surati va dalolatnomasi</td></tr><tr><td>03 Aloqa</td><td>Yopiq kanal</td><td>Dalolatnoma tizimga kiritiladi</td></tr><tr><td>04 Platforma</td><td>Avtomatik</td><td>Avtomatik</td></tr><tr><td>05 Qaror</td><td>Avtomatik</td><td>Avtomatik</td></tr></table><p>Farq tezlikda: qurilmali obyektda hodisa daqiqalar ichida bilinadi, qurilmasizida keyingi ko'rikkacha. Shuning uchun jihoz avval qiymati katta va ko'rigi siyrak obyektlarga qo'yiladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "На объекте без оборудования цепочка тоже не рвётся",
      tana: "<p>Оборудование не ставится на все 267 объектов одновременно. Но платформа с первого дня работает по всем объектам: просто первые три звена заполняет человек.</p><table><tr><th>Звено</th><th>Оборудование есть</th><th>Оборудования нет</th></tr><tr><td>01 Объект</td><td>Датчик и камера</td><td>Осмотр по плану</td></tr><tr><td>02 Комплект</td><td>Запись на месте и буфер</td><td>Фото инспектора и акт</td></tr><tr><td>03 Связь</td><td>Закрытый канал</td><td>Акт вносится в систему</td></tr><tr><td>04 Платформа</td><td>Автоматически</td><td>Автоматически</td></tr><tr><td>05 Решение</td><td>Автоматически</td><td>Автоматически</td></tr></table><p>Разница в скорости: на объекте с оборудованием о событии известно за минуты, без него — до следующего осмотра. Поэтому оборудование ставится в первую очередь на дорогие объекты с редкими осмотрами.</p>"
    }
  },
  ...
  "s-foyda.zaxira": {
    yorliq: "Moliya va huquq",
    sarlavha: "80 barobar qayerdan chiqdi",
    tana: "<p>Taqqoslashda ikkita raqam bor, ikkalasi ham taqdimotda keltirilgan.</p><table><tr><th>Nima</th><th>Summa</th></tr><tr><td>800 mln so'mlik obyekt 12 oyda sotilmasa, zaxira</td><td class='n'>800 mln so'm</td></tr><tr><td>O'sha obyektga nazorat komplekti</td><td class='n'>10 mln so'm</td></tr><tr><td>Nisbat</td><td class='n'>80 barobar</td></tr></table><p>Zaxira xarajat emas, balansdagi yozuv: u kapitalga bosim beradi. Komplekt esa haqiqiy xarajat. Shuning uchun ikki raqamni to'g'ridan-to'g'ri ayirib bo'lmaydi — taqqoslash faqat tartibni ko'rsatadi.</p><h4>Nazoratning zaxiraga aloqasi</h4><p>Kamera zaxirani o'zi kamaytirmaydi. Kartochkadagi sanoq muddatni ko'rinadigan qiladi: 180, 270 va 330-kunda realizatsiya mutaxassisiga va rahbariyatga eslatma boradi. Aktiv 365 kun ichida sotilsa, «umidsiz» toifaga umuman o'tmaydi.</p><p class='ogoh'>Bu bog'lanish pilotda o'lchanadi: nazoratli 10 obyekt shu turdagi nazoratsiz obyektlar bilan yonma-yon kuzatiladi. 10 obyekt statistik isbot uchun kam, u faqat yo'nalishni ko'rsatadi.</p>",
    manba: [["MB 2696-son nizom, lex.uz", "https://lex.uz/mact/-2703053"]],
    ru: {
      yorliq: "Финансы и право",
      sarlavha: "Откуда взялись 80 раз",
      tana: "<p>В сравнении две цифры, и обе приведены в презентации.</p><table><tr><th>Что</th><th>Сумма</th></tr><tr><td>Резерв, если объект за 800 млн сумов не продан за 12 месяцев</td><td class='n'>800 млн сумов</td></tr><tr><td>Комплект мониторинга на этот объект</td><td class='n'>10 млн сумов</td></tr><tr><td>Соотношение</td><td class='n'>80 раз</td></tr></table><p>Резерв — не расход, а запись на балансе: он давит на капитал. Комплект же — реальный расход. Поэтому вычитать одно из другого нельзя — сравнение показывает только порядок величин.</p><h4>При чём здесь мониторинг</h4><p>Камера сама резерв не уменьшает. Но счётчик в карточке делает срок видимым: на 180, 270 и 330-й день уходит напоминание специалисту по реализации и руководству. Если актив продан в пределах 365 дней, в категорию «безнадёжных» он вообще не переходит.</p><p class='ogoh'>Эта связь измеряется в пилоте: 10 объектов с мониторингом отслеживаются рядом с похожими объектами без него. 10 объектов мало для статистического доказательства, они показывают только направление.</p>"
    }
  },

  "s-foyda.qoriqlash": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "5,9 mln so'm ichida nima bor",
    tana: "<p>Raqam «Iqtisodiy asos» slaydidagi kalkulyatordan olingan va uchta qatordan yig'iladi. Bitta obyekt, bir yil.</p><table><tr><th>Qator</th><th>Yiliga</th></tr><tr><td>Komplektning yillik ulushi: 10 mln so'm, besh yilga taqsimlangan</td><td class='n'>2,0 mln so'm</td></tr><tr><td>SIM va servis</td><td class='n'>3,0 mln so'm</td></tr><tr><td>Markazning obyektga to'g'ri keladigan ulushi: 240 mln ÷ 267</td><td class='n'>0,9 mln so'm</td></tr><tr><td>Jami</td><td class='n'>5,9 mln so'm</td></tr></table><h4>Nima bilan solishtiriladi</h4><ul><li>IIV huzuridagi Qo'riqlash departamenti posti — yiliga 55 mln so'm.</li><li>Bankning o'z qorovuli, 24/7 post, to'rt xodim — 145 mln so'm.</li></ul><p>9,3 baravar farq eng arzon variantga nisbatan hisoblangan. Ular bir xil xizmat emas: qorovul jismonan to'sadi, nazorat esa ko'radi va qayd etadi. Shuning uchun nazorat qo'riqlashni hamma joyda almashtirmaydi — u qorovul umuman qo'yilmaydigan obyektlarni yopadi.</p><p class='ogoh'>Markaz xarajati — server, kanal va navbatchi smenasini o'z ichiga oladigan yillik 240 mln so'm. Bu faraz, aniq qiymati pilotdan keyin chiqadi.</p>",
    manba: [],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "Что входит в 5,9 млн сумов",
      tana: "<p>Цифра взята из калькулятора на слайде «Экономическое обоснование» и складывается из трёх строк. Один объект, один год.</p><table><tr><th>Строка</th><th>В год</th></tr><tr><td>Годовая доля комплекта: 10 млн сумов, распределённые на пять лет</td><td class='n'>2,0 млн сумов</td></tr><tr><td>SIM и сервис</td><td class='n'>3,0 млн сумов</td></tr><tr><td>Доля центра на объект: 240 млн ÷ 267</td><td class='n'>0,9 млн сумов</td></tr><tr><td>Итого</td><td class='n'>5,9 млн сумов</td></tr></table><h4>С чем сравнивается</h4><ul><li>Пост Департамента охраны при МВД — 55 млн сумов в год.</li><li>Собственный сторож банка, пост 24/7, четыре человека — 145 млн сумов.</li></ul><p>Разница в 9,3 раза посчитана к самому дешёвому варианту. Это не одна и та же услуга: сторож физически преграждает путь, мониторинг видит и фиксирует. Поэтому мониторинг не заменяет охрану везде — он закрывает объекты, где сторожа не будет вовсе.</p><p class='ogoh'>Расход центра — 240 млн сумов в год, включая сервер, канал и смену дежурных. Это допущение, точная величина появится после пилота.</p>"
    }
  },

  "s-foyda.sotuv": {
    yorliq: "Marketing uchun",
    sarlavha: "Narxni pasaytirishdan oldin tekshiriladigan uchta to'siq",
    tana: "<p>Lot sotilmay turganda odatda birinchi bo'lib narx pasaytiriladi. Undan oldin ko'riladigan uchta to'siq bor, va uchalasi ham jihoz o'rnatilgan obyektda yopiladi.</p><table><tr><th>To'siq</th><th>Nazorat nima beradi</th></tr><tr><td>E'londagi surat eski, mavsumi boshqa</td><td>Shu haftada olingan kadr va 30 soniyalik video</td></tr><tr><td>Har ko'rsatishga xodim safari kerak</td><td>Xaridor darvozada domofonni bosadi, operator videoda ko'rib eshikni ochadi</td></tr><tr><td>Xaridor ichkari holatiga ishonmaydi</td><td>Ichkaridagi kadr va tashriflar jurnali</td></tr></table><p>2025-yil 1-maydan davlat ulushi 50% va undan ko'p bo'lgan banklar balansdagi mulkni bozor qiymatida to'g'ridan-to'g'ri sotishi mumkin. Tashriflar jurnali bunday sotuvda xaridorlar ro'yxati bo'lib ham ishlaydi.</p><p class='ogoh'>Kamera obyektni sotmaydi va narxni belgilamaydi. U narx haqidagi qarorni his emas, raqam bilan qabul qilish imkonini beradi.</p>",
    manba: [["PQ-142, lex.uz", "https://lex.uz/docs/-7479146"]],
    ru: {
      yorliq: "Для маркетинга",
      sarlavha: "Три барьера, которые проверяют до снижения цены",
      tana: "<p>Когда лот не продаётся, первым делом обычно снижают цену. До этого стоит проверить три барьера, и все три закрываются на объекте с оборудованием.</p><table><tr><th>Барьер</th><th>Что даёт мониторинг</th></tr><tr><td>Фото в объявлении старое, снято в другой сезон</td><td>Кадр этой недели и видео на 30 секунд</td></tr><tr><td>На каждый показ нужен выезд сотрудника</td><td>Покупатель нажимает домофон у ворот, оператор видит его на видео и открывает дверь</td></tr><tr><td>Покупатель не верит в состояние внутри</td><td>Кадр изнутри и журнал визитов</td></tr></table><p>С 1 мая 2025 года банки с долей государства 50% и более вправе продавать имущество с баланса напрямую по рыночной стоимости. Журнал визитов работает при такой продаже и как список покупателей.</p><p class='ogoh'>Камера не продаёт объект и не назначает цену. Она позволяет принимать решение о цене по цифрам, а не по ощущению.</p>"
    }
  },

  "s-foyda.huquq": {
    yorliq: "Moliya va huquq",
    sarlavha: "To'rtta talab, to'rtta qaror",
    tana: "<p>Har bir talab loyihada aniq qarorga aylangan, chunki to'rttasi ham texnik topshiriqqa kiradi: harorat sinfi, ma'lumot joyi, datchik turi va montaj nuqtasi.</p><table><tr><th>Talab</th><th>Loyihadagi qaror</th></tr><tr><td>O'RQ-778: shartnoma asosida qo'riqlashni faqat davlat organi ko'rsatadi</td><td>Qorovul yollanmaydi; tasdiqlangan signal IIV huzuridagi Qo'riqlash departamenti pultiga uzatiladi</td></tr><tr><td>O'RQ-1125: biometrik ma'lumot O'zbekistonda saqlanadi</td><td>Yuzni tanish faqat bank serverida; kamera va hub bulut xizmati o'chirilgan holda sozlanadi</td></tr><tr><td>VMQ-649, 9-ilova: yong'in signalizatsiyasi majburiy binolar ro'yxati</td><td>Har obyekt turi ilova bilan solishtiriladi; qolgan binolarga batareyali yong'in datchigi</td></tr><tr><td>Tasvirga bo'lgan huquq qonun loyihasi, 07.10.2025: kamera oldida ogohlantirish belgisi</td><td>Belgi hozirdan har kirishga qo'yiladi; kamera qo'shni hovli va derazalarga qaratilmaydi</td></tr></table><p class='ogoh'>Ogohlantirish belgisi talabi hali qonun loyihasi. Uni hozirdan bajarish qo'shimcha xarajat talab qilmaydi va keyinchalik qayta ishlashdan saqlaydi.</p>",
    manba: [["O'RQ-778, lex.uz", "https://lex.uz/docs/-6066682"]],
    ru: {
      yorliq: "Финансы и право",
      sarlavha: "Четыре требования, четыре решения",
      tana: "<p>Каждое требование превращено в конкретное решение, потому что все четыре входят в техническое задание: температурный класс, место хранения данных, тип датчика и точка монтажа.</p><table><tr><th>Требование</th><th>Решение в проекте</th></tr><tr><td>ЗРУ-778: охрану по договору оказывает только государственный орган</td><td>Сторож не нанимается; подтверждённый сигнал уходит на пульт Департамента охраны при МВД</td></tr><tr><td>ЗРУ-1125: биометрические данные хранятся в Узбекистане</td><td>Распознавание лиц только на сервере банка; камера и хаб настраиваются с отключённым облаком</td></tr><tr><td>ПКМ-649, приложение 9: перечень зданий с обязательной пожарной сигнализацией</td><td>Каждый тип объекта сверяется с приложением; на остальные здания — пожарный датчик на батарее</td></tr><tr><td>Законопроект о праве на изображение, 07.10.2025: предупреждающий знак у камеры</td><td>Знак ставится уже сейчас у каждого входа; камера не направляется на соседний двор и окна</td></tr></table><p class='ogoh'>Требование о предупреждающем знаке пока остаётся законопроектом. Выполнить его сейчас не стоит дополнительных денег и избавляет от переделки позже.</p>"
    }
  },

  "s-foyda.qamrov": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Qamrov foizi: maxraj 267, surat har kuni o'zgaradi",
    tana: "<p>Nazorat qamrovi — loyihaning asosiy operatsion ko'rsatkichi. U ikkita ro'yxatdan hisoblanadi va ikkalasi ham reyestrda turadi.</p><h4>Hisoblash</h4><ul><li>Maxraj: balansdagi obyektlar soni. Bugun 267, u har oy o'zgaradi — yangi mulk keladi, sotilgani chiqadi.</li><li>Surat: qo'riqlash shartnomasi yoki ishlab turgan qurilmasi bor obyektlar.</li><li>«Ishlab turgan» degani oxirgi sutkada aloqada bo'lgan. Aloqadan chiqqan qurilma qamrovdan ham chiqadi.</li></ul><h4>Nazorat indeksi</h4><p>Har aktivga alohida indeks qo'yiladi: qurilma holati, ko'rik muddati, yopilmagan hodisalar va hujjatlar to'plami. Indeksi past obyektlar ro'yxati obyekt menejeriga kunlik vazifa bo'lib tushadi.</p><p class='ogoh'>Qamrov va indeks bo'yicha bazaviy raqam hali yo'q: u tizim ishga tushgan birinchi oyda o'lchanadi. Taqdimotdagi ekran namunalari shartli ma'lumot bilan to'ldirilgan.</p>",
    manba: [],
    ru: {
      yorliq: "Для руководства",
      sarlavha: "Процент охвата: знаменатель 267, числитель меняется каждый день",
      tana: "<p>Охват контролем — основной операционный показатель проекта. Он считается из двух списков, и оба есть в реестре.</p><h4>Расчёт</h4><ul><li>Знаменатель: число объектов на балансе. Сегодня 267, и он меняется каждый месяц — новое имущество приходит, проданное уходит.</li><li>Числитель: объекты, где есть договор охраны или работающее устройство.</li><li>«Работающее» значит выходившее на связь в последние сутки. Пропавшее со связи устройство выбывает и из охвата.</li></ul><h4>Индекс контроля</h4><p>По каждому активу ставится отдельный индекс: состояние устройства, срок осмотра, незакрытые события и комплект документов. Список объектов с низким индексом попадает менеджеру объекта дневной задачей.</p><p class='ogoh'>Базовой цифры по охвату и индексу пока нет: она будет измерена в первый месяц работы системы. Экраны в презентации заполнены условными данными.</p>"
    }
  },

  "s-foyda.xarajat": {
    yorliq: "Moliya va huquq",
    sarlavha: "1 575 mln so'm qanday yig'ildi",
    tana: "<table><tr><th>Qator</th><th>Yiliga</th></tr><tr><td>Komplektlar: 267 × 10 mln so'm, besh yilga taqsimlangan</td><td class='n'>534 mln so'm</td></tr><tr><td>SIM va servis: 267 × 3 mln so'm</td><td class='n'>801 mln so'm</td></tr><tr><td>Markaz: server, kanal, navbatchi smenasi</td><td class='n'>240 mln so'm</td></tr><tr><td>Jami</td><td class='n'>1 575 mln so'm</td></tr></table><p>Xarajat yillar bo'yicha bir tekis emas: birinchi yilda jihoz sotib olinadi, keyingi yillarda faqat SIM, servis va markaz qoladi. Besh yilga taqsimlash buxgalteriya hisobi uchun, pul oqimi uchun emas.</p><h4>Solishtirish</h4><p>Shu 267 obyektga qorovul posti qo'yilganda — bir obyektga oyiga 4,6 mln so'm hisobidan — nazoratdan yiliga 13 160 mln so'm ko'p to'lanardi.</p><p class='ogoh'>Uchala qator ham faraz: komplektning o'rtacha narxi, servis stavkasi va markaz xarajati. Uchalasi ham «Iqtisodiy asos» slaydidagi kalkulyatorda o'zgartiriladi, yakuniy raqam tenderdan keyin aniq bo'ladi.</p>",
    manba: [],
    ru: {
      yorliq: "Финансы и право",
      sarlavha: "Из чего сложились 1 575 млн сумов",
      tana: "<table><tr><th>Строка</th><th>В год</th></tr><tr><td>Комплекты: 267 × 10 млн сумов, распределённые на пять лет</td><td class='n'>534 млн сумов</td></tr><tr><td>SIM и сервис: 267 × 3 млн сумов</td><td class='n'>801 млн сумов</td></tr><tr><td>Центр: сервер, канал, смена дежурных</td><td class='n'>240 млн сумов</td></tr><tr><td>Итого</td><td class='n'>1 575 млн сумов</td></tr></table><p>По годам расход неравномерный: в первый год покупается оборудование, дальше остаются только SIM, сервис и центр. Распределение на пять лет нужно для бухгалтерского учёта, а не для денежного потока.</p><h4>Сравнение</h4><p>Если на те же 267 объектов поставить пост сторожа — из расчёта 4,6 млн сумов в месяц на объект, — платить пришлось бы на 13 160 млн сумов в год больше, чем за мониторинг.</p><p class='ogoh'>Все три строки — допущения: средняя цена комплекта, ставка сервиса и расход центра. Все три меняются в калькуляторе на слайде «Экономическое обоснование», окончательная цифра станет известна после тендера.</p>"
    }
  }
});

/* ---- kirish bobi ---- */
/* Kirish bobi: 03 · Taklif va 05 · Tizim slaydlarining batafsil yozuvlari. */
window.MKB_BATAFSIL = window.MKB_BATAFSIL || {};
Object.assign(window.MKB_BATAFSIL, {
  ...
  "s-taklif.korsat1": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "267 aktiv qayerdan kelgan va qachongacha turadi",
    tana: "<p>Bu mulk kredit qaytmagani uchun bank ixtiyoriga o'tgan: undiruv, sud qarori yoki takroriy savdo o'tmagani sababli o'zida qoldirish. Sotilgunga qadar aktiv bank balansida turadi, uning xarajati ham bankka yoziladi.</p><h4>Balansdagi yo'l</h4><table><tr><th>Bosqich</th><th>Nima yuritiladi</th></tr><tr><td>Balansga qabul</td><td>Dalolatnoma, baho va hujjatlar ro'yxati. Muddat sanog'i shu kundan boshlanadi</td></tr><tr><td>Saqlash</td><td>Soliq, kommunal to'lov, sug'urta, qo'riqlash va servis xarajati</td></tr><tr><td>Realizatsiya</td><td>Sotuvga tayyorlash, lot, e'lon, tashrif, taklif, shartnoma</td></tr><tr><td>Chiqim</td><td>Sotuv yoki hisobdan chiqarish; kartochka tarixi bilan arxivga o'tadi</td></tr></table><p>Ro'yxat qotib qolgan emas: yangi aktiv qabul qilinganda reyestrga qo'shiladi, sotilgach arxivga o'tadi. Loyiha butun ro'yxatga taalluqli, faqat qurilma turi obyektga qarab farq qiladi.</p><p>Tarkibi <a data-slayd='#s-tarkib' href='#'>«Balans tarkibi» slaydida</a>.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Откуда взялись 267 активов и как долго они стоят",
      tana: "<p>Это имущество перешло банку из-за невозврата кредита: взыскание, решение суда или оставление за собой после несостоявшихся повторных торгов. До продажи актив стоит на балансе банка, и расходы по нему тоже ложатся на банк.</p><h4>Путь по балансу</h4><table><tr><th>Стадия</th><th>Что ведётся</th></tr><tr><td>Приём на баланс</td><td>Акт, оценка и перечень документов. Отсчёт сроков начинается с этого дня</td></tr><tr><td>Хранение</td><td>Налог, коммунальные платежи, страховка, охрана и сервис</td></tr><tr><td>Реализация</td><td>Подготовка к продаже, лот, объявление, показ, предложение, договор</td></tr><tr><td>Выбытие</td><td>Продажа или списание; карточка с историей уходит в архив</td></tr></table><p>Список не статичен: новый актив попадает в реестр при приёме, проданный уходит в архив. Проект охватывает весь список, различается только тип оборудования под конкретный объект.</p><p>Состав — на <a data-slayd='#s-tarkib' href='#'>слайде «Состав баланса»</a>.</p>"
    }
  },

  "s-taklif.korsat2": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Nega bitta universal komplekt yetmaydi",
    tana: "<p>Balansdagi 188 obyekt — bino va inshoot, 79 tasi ko'char mulk. Kameraga devor, ko'rish burchagi va quvvat manbai kerak; avtomobil yoki stanokda bularning uchtasi ham yo'q.</p><table><tr><th>Sinf</th><th>Soni</th><th>Nazorat usuli</th></tr><tr><td>Bino va inshoot</td><td class='n'>188</td><td>Kamera, kirish nazorati, datchik</td></tr><tr><td>Avtotransport</td><td class='n'>42</td><td>GPS-treker va plomba</td></tr><tr><td>Asbob-uskuna</td><td class='n'>30</td><td>Plomba, saqlash joyiga umumiy kamera</td></tr><tr><td>Yuk avtomobili va maxsus texnika</td><td class='n'>7</td><td>GPS-treker va plomba</td></tr></table><h4>Binolar ham bir xil emas</h4><p>Ro'yxatda 62 ma'muriy bino, 32 chorvachilik fermasi, 24 ishlab chiqarish sexi, 18 xonadon, 18 savdo do'koni, 12 ombor va 6 issiqxona bor. Shahar markazidagi xonadonda doimiy tok ham, qo'shni ham bor; tumandagi fermada ikkalasi ham yo'q.</p><p class='ogoh'>Shuning uchun taqdimotda bitta emas, o'nta yechim solishtirilgan: <a data-slayd='#s-matritsa' href='#'>«O'nta yechim» slaydi</a>.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Почему один универсальный комплект не подходит",
      tana: "<p>Из активов на балансе 188 — здания и сооружения, 79 — движимое имущество. Камере нужны стена, угол обзора и питание; у автомобиля или станка нет ни того, ни другого, ни третьего.</p><table><tr><th>Класс</th><th>Кол-во</th><th>Способ контроля</th></tr><tr><td>Здания и сооружения</td><td class='n'>188</td><td>Камера, контроль доступа, датчики</td></tr><tr><td>Автотранспорт</td><td class='n'>42</td><td>GPS-трекер и пломба</td></tr><tr><td>Оборудование</td><td class='n'>30</td><td>Пломба, общая камера на площадке хранения</td></tr><tr><td>Грузовики и спецтехника</td><td class='n'>7</td><td>GPS-трекер и пломба</td></tr></table><h4>Здания тоже разные</h4><p>В списке 62 административных здания, 32 животноводческие фермы, 24 производственных цеха, 18 квартир, 18 магазинов, 12 складов и 6 теплиц. В городской квартире есть и постоянное питание, и соседи; у фермы в районе нет ни того, ни другого.</p><p class='ogoh'>Поэтому в презентации сравниваются не одно, а десять решений: <a data-slayd='#s-matritsa' href='#'>слайд «Десять решений»</a>.</p>"
    }
  },

  "s-taklif.korsat3": {
    yorliq: "Moliya uchun",
    sarlavha: "3–20 mln so'm ichiga nima kiradi",
    tana: "<p>Oraliq bitta obyektning jihozi va o'rnatilishiga tegishli. O'nta yechimdan yettitasi shu oraliqqa sig'adi, uchtasi alohida holat uchun qimmatroq.</p><table><tr><th>Yechim</th><th>Bir obyektga</th></tr><tr><td>Milesight LoRaWAN datchiklari</td><td class='n'>3–8 mln</td></tr><tr><td>Hikvision quyosh-4G</td><td class='n'>5–9 mln</td></tr><tr><td>Ajax datchiklari</td><td class='n'>7–10 mln</td></tr><tr><td>Dahua quyosh-4G va ko'chma stansiya</td><td class='n'>7–16 mln</td></tr><tr><td>Reolink va Home Hub</td><td class='n'>8–12 mln</td></tr><tr><td>LiFePO4 shkafi</td><td class='n'>12–20 mln</td></tr><tr><td>Klaster shkafi, 3–10 qo'shni obyektga bitta</td><td class='n'>20–40 mln</td></tr><tr><td>Mobil minora</td><td class='n'>40–120 mln</td></tr><tr><td>EFOY yoqilg'i elementi</td><td class='n'>80–170 mln</td></tr></table><h4>Nima kirmaydi</h4><ul><li>SIM trafigi va servis — yillik xarajat qatorida.</li><li>Markaz serverlari va jamoa — alohida qator.</li><li>Elektrga qayta ulash mumkin bo'lgan obyektda avval shu yo'l sinaladi: texnik shart 39 600 so'm.</li></ul><p>Yakuniy narxni tenderdagi kamida uchta taklif belgilaydi: <a data-slayd='#s-narx' href='#'>«Narx» slaydi</a>. Jihoz bo'yicha bandma-band smeta <a data-slayd='#s-bom' href='#'>«Smeta» slaydida</a>.</p>",
    manba: [],
    ru: {
      yorliq: "Для финансов",
      sarlavha: "Что входит в 3–20 млн сумов",
      tana: "<p>Диапазон относится к оборудованию и монтажу одного объекта. Семь решений из десяти укладываются в него, три дороже и нужны для особых случаев.</p><table><tr><th>Решение</th><th>На объект</th></tr><tr><td>Датчики Milesight LoRaWAN</td><td class='n'>3–8 млн</td></tr><tr><td>Hikvision солнце-4G</td><td class='n'>5–9 млн</td></tr><tr><td>Датчики Ajax</td><td class='n'>7–10 млн</td></tr><tr><td>Dahua солнце-4G и переносная станция</td><td class='n'>7–16 млн</td></tr><tr><td>Reolink и Home Hub</td><td class='n'>8–12 млн</td></tr><tr><td>Шкаф LiFePO4</td><td class='n'>12–20 млн</td></tr><tr><td>Кластерный шкаф, один на 3–10 соседних объектов</td><td class='n'>20–40 млн</td></tr><tr><td>Мобильная вышка</td><td class='n'>40–120 млн</td></tr><tr><td>Топливный элемент EFOY</td><td class='n'>80–170 млн</td></tr></table><h4>Что не входит</h4><ul><li>Трафик SIM и сервис — в строке годовых расходов.</li><li>Серверы центра и команда — отдельной строкой.</li><li>Если объект можно вернуть в сеть, сначала пробуем этот путь: техусловия стоят 39 600 сумов.</li></ul><p>Итоговую цену определят минимум три предложения на тендере: <a data-slayd='#s-narx' href='#'>слайд «Цена»</a>. Посписочная смета по оборудованию — на <a data-slayd='#s-bom' href='#'>слайде «Смета»</a>.</p>"
    }
  },

  "s-taklif.qamrov": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Loyiha qayerdan boshlanib qayerda tugaydi",
    tana: "<p>Chegara aniq: balansga qabul qilingan kundan balansdan chiqim kunigacha bo'lgan butun davr va shu davrdagi 267 aktivning hammasi. Amaldagi kreditlarning garov mulki bu loyihaga kirmaydi — u hali bank balansida emas.</p><h4>Qurilma qayerga qo'yiladi</h4><table><tr><th>Obyekt</th><th>Qaror</th></tr><tr><td>Bino va inshoot</td><td>Kamera majburiy: kirish eshigi kadr markazida</td></tr><tr><td>Avtotransport va texnika</td><td>Kamera emas — plomba va GPS-treker</td></tr><tr><td>Bo'sh yer uchastkasi</td><td>Kamera qo'yilmaydi: qo'riqlanadigan narsa yo'q</td></tr><tr><td>Qo'shni 3–10 obyekt</td><td>Bitta klaster shkafi: aloqa va quvvat umumiy</td></tr></table><h4>Nimani o'z ichiga olmaydi</h4><ul><li>Obyektga doimiy qorovul qo'yish: bu yiliga 145 mln so'm, masofaviy nazorat esa 5,9 mln.</li><li>Yuzni tanish: yoqilsa, O'RQ-1125 bo'yicha ma'lumot bank serverida qoladi va bu alohida qaror.</li></ul><p class='ogoh'>Elektrga qayta ulash mumkin bo'lgan obyektda avval shu yo'l sinaladi. Avtonom yechim faqat ulab bo'lmaydigan joyga qo'yiladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Где проект начинается и где заканчивается",
      tana: "<p>Граница чёткая: весь период от дня приёма на баланс до дня выбытия и все 267 активов внутри этого периода. Залоговое имущество по действующим кредитам в проект не входит — оно ещё не на балансе банка.</p><h4>Куда ставится оборудование</h4><table><tr><th>Объект</th><th>Решение</th></tr><tr><td>Здания и сооружения</td><td>Камера обязательна: входная дверь в центре кадра</td></tr><tr><td>Автотранспорт и техника</td><td>Не камера — пломба и GPS-трекер</td></tr><tr><td>Пустой земельный участок</td><td>Камера не ставится: охранять нечего</td></tr><tr><td>3–10 соседних объектов</td><td>Один кластерный шкаф: связь и питание общие</td></tr></table><h4>Что в проект не входит</h4><ul><li>Постоянный сторож на объекте: это 145 млн сумов в год против 5,9 млн за удалённый контроль.</li><li>Распознавание лиц: если его включать, по ЗРУ-1125 данные остаются на сервере банка, и это отдельное решение.</li></ul><p class='ogoh'>Если объект можно вернуть в электросеть, сначала пробуем этот путь. Автономное решение ставится только там, где подключиться нельзя.</p>"
    }
  },

  "s-taklif.bugun": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Bugun ishlab turgan qism",
    tana: "<p>Taqdimotdagi ekranlar maket emas. Reyestr, obyekt kartochkasi, ko'rik va realizatsiya bitta bazada ishlaydi; namoyish hisobi bilan istalgan payt ochib ko'rsatish mumkin.</p><table><tr><th>Bo'lim</th><th>Nima qiladi</th></tr><tr><td>Reyestr va kartochka</td><td>267 aktiv: qiymat, bosqich, hudud, hujjatlar, xarajat</td></tr><tr><td>Muddat va zaxira</td><td>Balansga qabul sanasi, soliq imtiyozi, 12 oylik chegara, zaxira toifasi</td></tr><tr><td>Ko'rik va inventarizatsiya</td><td>Ko'rik rejasi, dalolatnoma, kechikkanlar ro'yxati</td></tr><tr><td>Himoya va monitoring</td><td>Qo'riqlash shartnomasi, kommunal, tashriflar, ruxsatlar</td></tr><tr><td>Realizatsiya</td><td>Lot, e'lon, tashrif, taklif, shartnoma</td></tr><tr><td>Hisobot</td><td>Markaziy bank shakli, hudud va portfel kesimi, eksport</td></tr></table><p>Rol bank AD guruhidan olinadi, har o'zgarish audit jurnaliga tushadi.</p><p>Ekranlar <a data-slayd='#s-tizim' href='#'>«Tizim» slaydida</a> ko'rsatiladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Часть, которая работает уже сегодня",
      tana: "<p>Экраны в презентации — не макеты. Реестр, карточка объекта, осмотры и реализация работают в одной базе; под демо-учётной записью систему можно открыть в любой момент.</p><table><tr><th>Раздел</th><th>Что делает</th></tr><tr><td>Реестр и карточка</td><td>267 активов: стоимость, стадия, регион, документы, расходы</td></tr><tr><td>Сроки и резерв</td><td>Дата приёма на баланс, налоговая льгота, граница 12 месяцев, категория резерва</td></tr><tr><td>Осмотры и инвентаризация</td><td>План осмотров, акт, список просроченных</td></tr><tr><td>Защита и мониторинг</td><td>Договор охраны, коммунальные, показы, допуски</td></tr><tr><td>Реализация</td><td>Лот, объявление, показ, предложение, договор</td></tr><tr><td>Отчётность</td><td>Форма для Центрального банка, разрезы по регионам и портфелю, экспорт</td></tr></table><p>Роль берётся из группы AD банка, каждое изменение попадает в журнал аудита.</p><p>Экраны показаны на <a data-slayd='#s-tizim' href='#'>слайде «Система»</a>.</p>"
    }
  },

  "s-taklif.qoshiladi": {
    yorliq: "Jamoa rahbarlari uchun",
    sarlavha: "Pilotda quriladigan to'rtta komponent",
    tana: "<p>Bugungi tizimda qurilma qismi yo'q. Uni to'rtta komponent yopadi; qolgan hamma narsa — reyestr, kartochka, rollar, hisobot — o'zgarishsiz qoladi.</p><table><tr><th>Komponent</th><th>Vazifasi</th></tr><tr><td>Qurilmalar reyestri</td><td>Har qurilma obyektga biriktiriladi: seriya raqami, QR-yorliq, kafolat, servis tarixi</td></tr><tr><td>Hodisa shinasi</td><td>Brenddan mustaqil yagona sxema: harakat, eshik, tutun, buzish, batareya past, aloqa yo'q</td></tr><tr><td>Media shlyuz</td><td>RTSP oqimini brauzerga faqat operator obyektni ochganda uzatadi</td></tr><tr><td>Buyruq xizmati</td><td>Eshikni ochish, sirenani yoqish; har buyruq kim va qachon berganini yozib qoldiradi</td></tr></table><h4>Yuklama</h4><p>Obyektga o'rtacha to'rtta qurilma to'g'ri keladi: 300 obyekt — 1 200 qurilma va kuniga taxminan 36 000 hodisa. Shu hisob <a data-slayd='#s-masshtab' href='#'>«Masshtab» slaydida</a> uch bosqich uchun ochib berilgan.</p><p>Qatlamlar va ular orasidagi chegara <a data-slayd='#s-arx' href='#'>«Integratsiya» slaydida</a>.</p>",
    manba: [],
    ru: {
      yorliq: "Для тимлидов",
      sarlavha: "Четыре компонента, которые строятся в пилоте",
      tana: "<p>В сегодняшней системе нет части, отвечающей за устройства. Её закрывают четыре компонента; всё остальное — реестр, карточка, роли, отчётность — остаётся как есть.</p><table><tr><th>Компонент</th><th>Задача</th></tr><tr><td>Реестр устройств</td><td>Каждое устройство привязано к объекту: серийный номер, QR-метка, гарантия, история сервиса</td></tr><tr><td>Шина событий</td><td>Единая схема, не зависящая от бренда: движение, дверь, дым, вскрытие, низкий заряд, нет связи</td></tr><tr><td>Медиашлюз</td><td>Отдаёт поток RTSP в браузер только когда оператор открыл объект</td></tr><tr><td>Сервис команд</td><td>Открыть дверь, включить сирену; по каждой команде пишется, кто и когда её отдал</td></tr></table><h4>Нагрузка</h4><p>На объект приходится в среднем четыре устройства: 300 объектов — это 1 200 устройств и около 36 000 событий в сутки. Расчёт по трём этапам — на <a data-slayd='#s-masshtab' href='#'>слайде «Масштаб»</a>.</p><p>Слои и границы между ними — на <a data-slayd='#s-arx' href='#'>слайде «Интеграция»</a>.</p>"
    }
  },

  "s-taklif.narx": {
    yorliq: "Moliya uchun",
    sarlavha: "Narx qatori qanday yig'ilgan",
    tana: "<p>Uchta raqam uch xil manbadan keladi va bir-birini almashtirmaydi.</p><table><tr><th>Qator</th><th>Hisob</th><th>Summa</th></tr><tr><td>Jihoz va montaj, bir marta</td><td>267 × 3–20 mln so'm</td><td class='n'>0,8–5,3 mlrd</td></tr><tr><td>Shundan o'rtacha stsenariy</td><td>267 × 10 mln so'm</td><td class='n'>2,7 mlrd</td></tr><tr><td>Ekspluatatsiya, yiliga</td><td>Komplekt amortizatsiyasi, SIM, servis va markaz</td><td class='n'>1 575 mln</td></tr><tr><td>Pilot jihozi</td><td>10 obyekt, 3–4 yechim yonma-yon</td><td class='n'>30–200 mln</td></tr></table><h4>Nima alohida qator</h4><ul><li>Jamoa: backend 2, frontend 1, DevOps 1, QA 1, integratsiya 1, loyiha menejeri 1.</li><li>Markaz serverlari va obyekt ombori.</li></ul><p>Solishtirish uchun: shu 267 obyektga qorovul posti qo'yilganda yiliga 13 160 mln so'm to'lanardi. Hisob <a data-slayd='#s-iqtisod' href='#'>«Iqtisod» slaydida</a>.</p><p class='ogoh'>Bugun tasdiqlanadigan summa — faqat pilot jihozi. Butun dastur byudjeti oltinchi haftadagi smetadan keyin so'raladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для финансов",
      sarlavha: "Из чего сложилась строка цены",
      tana: "<p>Три цифры берутся из трёх разных источников и не заменяют друг друга.</p><table><tr><th>Строка</th><th>Расчёт</th><th>Сумма</th></tr><tr><td>Оборудование и монтаж, разово</td><td>267 × 3–20 млн сумов</td><td class='n'>0,8–5,3 млрд</td></tr><tr><td>Средний сценарий из него</td><td>267 × 10 млн сумов</td><td class='n'>2,7 млрд</td></tr><tr><td>Эксплуатация, в год</td><td>Амортизация комплекта, SIM, сервис и центр</td><td class='n'>1 575 млн</td></tr><tr><td>Оборудование пилота</td><td>10 объектов, 3–4 решения рядом</td><td class='n'>30–200 млн</td></tr></table><h4>Что идёт отдельной строкой</h4><ul><li>Команда: два backend, один frontend, DevOps, QA, интеграция, руководитель проекта.</li><li>Серверы центра и объектное хранилище.</li></ul><p>Для сравнения: пост охраны на этих же 267 объектах обошёлся бы в 13 160 млн сумов в год. Расчёт — на <a data-slayd='#s-iqtisod' href='#'>слайде «Экономика»</a>.</p><p class='ogoh'>Сегодня утверждается только сумма на оборудование пилота. Бюджет всей программы запрашивается после сметы на шестой неделе.</p>"
    }
  },

  "s-taklif.qaror": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Nega aynan shu to'rtta qaror",
    tana: "<p>Bugun butun dastur byudjeti so'ralmayapti. So'ralayotgan to'rt band pilotni boshlash uchun yetarli va eng kichik ro'yxat: biri bo'lmasa, ish birinchi haftadayoq to'xtaydi.</p><table><tr><th>Qaror</th><th>Nimani ochadi</th><th>Kim tayyorlaydi</th></tr><tr><td>10 ta pilot obyekt</td><td>Audit va montaj marshruti; kamida ikki viloyat, to'rt xil obyekt turi</td><td>Muammoli aktivlar bo'limi</td></tr><tr><td>Jihoz byudjeti 30–200 mln so'm</td><td>Kommersiya taklifini so'rash va xarid</td><td>Moliya va ta'minot</td></tr><tr><td>Bosh integrator modeli</td><td>Bitta javobgar tomon: montaj, sozlash va kafolat bo'linib ketmaydi</td><td>Yuridik departament</td></tr><tr><td>Ulanish standarti</td><td>Har brend MKB API'siga ulanadi, sotuvchi buluti orqali emas</td><td>AT departamenti</td></tr></table><h4>Qaror qabul qilingandan keyin</h4><ol><li>1-hafta: 10 obyekt auditi, signal va quvvat o'lchovi.</li><li>2-hafta: kamida uchta integratordan taklif, 3–4 yechim tanlanadi.</li><li>6-hafta: smeta, SLA va 267 obyekt uchun joriy etish standarti.</li></ol><p>Pilot rejasi va muvaffaqiyat mezonlari <a data-slayd='#s-pilot' href='#'>«Pilot» slaydida</a>.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Почему именно эти четыре решения",
      tana: "<p>Бюджет всей программы сегодня не запрашивается. Четыре пункта — это минимальный набор, которого хватает, чтобы начать пилот: без любого из них работа остановится на первой же неделе.</p><table><tr><th>Решение</th><th>Что открывает</th><th>Кто готовит</th></tr><tr><td>10 пилотных объектов</td><td>Аудит и маршрут монтажа; не меньше двух областей и четыре типа объектов</td><td>Отдел проблемных активов</td></tr><tr><td>Бюджет на оборудование 30–200 млн сумов</td><td>Запрос коммерческих предложений и закупку</td><td>Финансы и снабжение</td></tr><tr><td>Модель генерального интегратора</td><td>Одна ответственная сторона: монтаж, настройка и гарантия не расходятся по подрядчикам</td><td>Юридический департамент</td></tr><tr><td>Стандарт подключения</td><td>Любой бренд подключается к API банка, а не через облако вендора</td><td>ИТ-департамент</td></tr></table><h4>Что происходит после решения</h4><ol><li>1-я неделя: аудит 10 объектов, замер сигнала и питания.</li><li>2-я неделя: предложения минимум от трёх интеграторов, выбор 3–4 решений.</li><li>6-я неделя: смета, SLA и стандарт внедрения на 267 объектов.</li></ol><p>План пилота и критерии успеха — на <a data-slayd='#s-pilot' href='#'>слайде «Пилот»</a>.</p>"
    }
  },
  ...
  "s-tizim.reyestr": {
    yorliq: "Texnik izoh",
    sarlavha: "Reyestr: 267 aktiv bitta ro'yxatda",
    tana: "<p>Reyestr — balansdagi har bir obyektning yagona ro'yxati. Bu yerdan istalgan obyekt kartochkasi ochiladi, boshqa joyda parallel ro'yxat yuritilmaydi.</p><h4>Ro'yxatda nima ko'rinadi</h4><ul><li><b>Kartalar yoki jadval:</b> surat, nom, balans qiymati, tur, maydon va nazorat indeksi.</li><li><b>Filtrlar:</b> bosqich (balansda, sud jarayonida, qaror ijrosi, musodara) va hudud bo'yicha, matnli qidiruv.</li><li><b>Xaritada:</b> obyektlar joylashuvi. Montaj marshrutini tuzish va klaster shkafi uchun qo'shni obyektlarni topish shu yerdan qulay.</li><li><b>Arxiv:</b> sotilgan va chiqarilgan obyektlar tarixi bilan saqlanadi.</li><li><b>Balansga qabul:</b> yangi obyekt hujjatlari bilan shu yerda kiritiladi.</li></ul><h4>Qurilma ulangandan keyin</h4><p>Ro'yxatga ikkita ustun qo'shiladi: aloqadagi qurilmalar soni va ochiq hodisalar. Filtrlar orasida «qurilmasi yo'q» va «aloqadan chiqqan» paydo bo'ladi — montaj navbati aynan shu filtrdan tuziladi.</p>",
    manba: [],
    ru: {
      yorliq: "Техническая справка",
      sarlavha: "Реестр: 267 активов в одном списке",
      tana: "<p>Реестр — единый список всех объектов на балансе. Отсюда открывается карточка любого объекта, параллельных списков больше нигде не ведётся.</p><h4>Что видно в списке</h4><ul><li><b>Карточки или таблица:</b> фото, название, балансовая стоимость, тип, площадь и индекс контроля.</li><li><b>Фильтры:</b> по стадии (на балансе, в суде, исполнение решения, конфискация) и региону, текстовый поиск.</li><li><b>На карте:</b> расположение объектов. Отсюда удобно строить маршрут монтажа и искать соседние объекты под кластерный шкаф.</li><li><b>Архив:</b> проданные и выбывшие объекты хранятся вместе с историей.</li><li><b>Приём на баланс:</b> новый объект заводится здесь вместе с документами.</li></ul><h4>После подключения устройств</h4><p>В списке появятся две колонки: число устройств на связи и открытые события. Среди фильтров добавятся «без устройств» и «нет связи» — очередь на монтаж собирается именно по ним.</p>"
    }
  },

  "s-tizim.muddat": {
    yorliq: "Moliya uchun",
    sarlavha: "Muddat va zaxira: sanoq qabul kunidan boshlanadi",
    tana: "<p>Obyekt kartochkasidagi shkala to'rtta sanani bitta chiziqda ko'rsatadi, shuning uchun zaxira toifasini balans ma'lumoti bilan qo'lda solishtirish shart emas.</p><table><tr><th>Nuqta</th><th>Ma'nosi</th></tr><tr><td>Balansga qabul</td><td>Dalolatnoma sanasi; barcha muddatlar shundan sanaladi</td></tr><tr><td>Soliq imtiyozining tugashi</td><td>Qabuldan olti oy. Faqat binoli aktivga tegishli, transport va uskunaga emas</td></tr><tr><td>12 oylik chegara</td><td>Shundan keyin aktiv «umidsiz» toifaga o'tadi va 100% zaxira talab qiladi</td></tr><tr><td>3 yil</td><td>Uzoq turib qolgan aktivlar alohida ko'rib chiqiladi</td></tr></table><p>Shkala ustida ikki raqam turadi: aktiv balansda necha kun bo'lgani va umidsiz toifagacha necha kun qolgani. Rahbariyat panelidagi «90 kundan kam qolgan aktivlar» ro'yxati shu sanoqdan yig'iladi.</p><p class='ogoh'>Asos — Markaziy bankning 2696-son nizomi, 20-band. Me'yoriy talablar <a data-slayd='#s-meyor' href='#'>«Me'yorlar» slaydida</a> bandma-band keltirilgan.</p>",
    manba: [],
    ru: {
      yorliq: "Для финансов",
      sarlavha: "Сроки и резерв: отсчёт идёт со дня приёма",
      tana: "<p>Шкала в карточке объекта показывает четыре даты на одной линии, поэтому категорию резерва не нужно вручную сверять с балансовыми данными.</p><table><tr><th>Точка</th><th>Что означает</th></tr><tr><td>Приём на баланс</td><td>Дата акта; от неё считаются все сроки</td></tr><tr><td>Окончание налоговой льготы</td><td>Шесть месяцев с приёма. Относится только к активам со зданием, но не к транспорту и оборудованию</td></tr><tr><td>Граница 12 месяцев</td><td>После неё актив переходит в «безнадёжную» категорию и требует резерва 100%</td></tr><tr><td>Три года</td><td>Долго стоящие активы рассматриваются отдельно</td></tr></table><p>Над шкалой две цифры: сколько дней актив на балансе и сколько осталось до безнадёжной категории. Из этого же отсчёта на панели правления собирается список активов, которым осталось меньше 90 дней.</p><p class='ogoh'>Основание — положение Центрального банка № 2696, пункт 20. Нормативные требования разобраны по пунктам на <a data-slayd='#s-meyor' href='#'>слайде «Нормы»</a>.</p>"
    }
  },

  "s-tizim.korik": {
    yorliq: "Ko'rik inspektori uchun",
    sarlavha: "Ko'rik: reja, dalolatnoma va kechikkanlar",
    tana: "<p>Ko'rik tizimda alohida hujjat emas, muddatli vazifa. Reja sanasi kelganda obyekt ro'yxatga tushadi, dalolatnoma to'ldirilgach vazifa yopiladi.</p><h4>Ish tartibi</h4><ol><li>Reja obyekt turiga qarab tuziladi; misoldagi ma'muriy bino uchun me'yor — har 90 kunda bir marta.</li><li>Inspektor tayinlanadi; ro'yxatda sana, obyekt, inspektor va qolgan kun turadi.</li><li>Ko'rik o'tkazilgach dalolatnoma, surat va aniqlangan kamchiliklar kartochkaga biriktiriladi.</li><li>Sana o'tib ketsa, obyekt «kechikkanlar» ro'yxatiga tushadi va nazorat indeksidan ball yo'qotadi.</li></ol><h4>Kamera o'rnatilgandan keyin</h4><p>Kamerali obyektda masofaviy ko'rik ochiladi: inspektor jonli kadr va oxirgi hodisalarni ko'radi, o'sha kadrni dalolatnomaga ilova qiladi. Safar faqat kamchilik topilganda yoki me'yor joyida borishni talab qilganda qoladi.</p>",
    manba: [],
    ru: {
      yorliq: "Для инспектора осмотров",
      sarlavha: "Осмотры: план, акт и просроченные",
      tana: "<p>Осмотр в системе — не отдельный документ, а задача со сроком. Когда подходит плановая дата, объект попадает в список; после заполнения акта задача закрывается.</p><h4>Порядок работы</h4><ol><li>План строится по типу объекта; для административного здания в примере норматив — раз в 90 дней.</li><li>Назначается инспектор; в списке видны дата, объект, инспектор и сколько дней осталось.</li><li>После осмотра акт, фотографии и выявленные замечания прикрепляются к карточке.</li><li>Если дата прошла, объект попадает в список просроченных и теряет баллы в индексе контроля.</li></ol><h4>После установки камеры</h4><p>На объекте с камерой открывается удалённый осмотр: инспектор видит живой кадр и последние события и прикладывает этот кадр к акту. Выезд остаётся там, где найдено замечание или где норматив требует осмотра на месте.</p>"
    }
  },

  "s-tizim.himoya": {
    yorliq: "Xavfsizlik xizmati uchun",
    sarlavha: "Himoya va monitoring: bugun shartnoma, ertaga qurilma",
    tana: "<p>Bugun bu bo'limda obyekt himoyasi hujjat darajasida yuritiladi: qo'riqlash shartnomasi, kommunal holat, tashriflar va kirish ruxsatlari. Qurilma qismi bo'sh — aynan shu bo'shliqni loyiha yopadi.</p><table><tr><th>Bo'lim</th><th>Bugun</th><th>Qurilma ulangach</th></tr><tr><td>Qo'riqlash</td><td>Shartnoma, post turi, to'lov</td><td>Tasdiqlangan signal IIV pultiga uzatiladi</td></tr><tr><td>Qurilmalar</td><td>Ro'yxat bo'sh</td><td>Seriya raqami, batareya, oxirgi signal, servis tarixi</td></tr><tr><td>Hodisalar</td><td>Qo'lda kiritilgan voqealar</td><td>Harakat, eshik, tutun, buzish — avtomatik</td></tr><tr><td>Masofaviy ko'rik</td><td>Faqat hujjat bo'yicha</td><td>Jonli kadr va arxiv klipi dalolatnomaga</td></tr></table><h4>Kim nimani ko'radi</h4><p>Navbatchi operator faqat qaror talab qiladigan hodisani ko'radi: buzish, tutun, ish vaqtidan tashqari eshik. Batareya pasayishi servis navbatiga tushadi va telefonni bezovta qilmaydi. Filial xodimi boshqa hudud obyektini ko'rmaydi.</p>",
    manba: [],
    ru: {
      yorliq: "Для службы безопасности",
      sarlavha: "Защита и мониторинг: сегодня договор, завтра устройство",
      tana: "<p>Сегодня в этом разделе защита объекта ведётся на уровне документов: договор охраны, состояние коммуникаций, показы и допуски. Часть по устройствам пустая — именно её закрывает проект.</p><table><tr><th>Раздел</th><th>Сегодня</th><th>После подключения</th></tr><tr><td>Охрана</td><td>Договор, тип поста, оплата</td><td>Подтверждённая тревога уходит на пульт МВД</td></tr><tr><td>Устройства</td><td>Список пуст</td><td>Серийный номер, заряд, последний сигнал, история сервиса</td></tr><tr><td>События</td><td>Внесённые вручную</td><td>Движение, дверь, дым, вскрытие — автоматически</td></tr><tr><td>Удалённый осмотр</td><td>Только по документам</td><td>Живой кадр и архивный клип в акт</td></tr></table><h4>Кто что видит</h4><p>Дежурный оператор видит только события, требующие решения: вскрытие, дым, открытие двери в нерабочее время. Низкий заряд уходит в сервисную очередь и телефон не беспокоит. Сотрудник филиала не видит объекты чужого региона.</p>"
    }
  },

  "s-tizim.realizatsiya": {
    yorliq: "Realizatsiya uchun",
    sarlavha: "Realizatsiya: lotdan shartnomagacha",
    tana: "<p>Sotuv zanjiri kartochkaning davomi: obyekt sotuvga tayyorlanadi, lotga qo'yiladi, e'lon beriladi, tashrif va taklif yoziladi, shartnoma bilan yopiladi. Har qadam sana va mas'ul bilan qoladi.</p><h4>Nazorat nima beradi</h4><ul><li>E'longa arxivdagi eski surat emas, shu haftada olingan kadr qo'yiladi.</li><li>Xaridor darvozada domofonni bosadi, operator uni videoda ko'rib eshikni ochadi — xodim obyektga bormaydi.</li><li>Tashriflar haftaning bir kuniga yig'iladi va jurnalda qoladi.</li></ul><h4>O'lchov</h4><p>Bitta ko'rsatkich: e'londan shartnomagacha necha kun o'tdi. Chegara 365 kun, chunki undan keyin aktiv «umidsiz» toifaga o'tadi; maqsad undan ancha oldin sotish.</p><p>Batafsil <a data-slayd='#s-sotuv' href='#'>«Tez sotuv» slaydida</a>.</p>",
    manba: [],
    ru: {
      yorliq: "Для реализации",
      sarlavha: "Реализация: от лота до договора",
      tana: "<p>Цепочка продажи — продолжение карточки: объект готовят к продаже, ставят в лот, публикуют объявление, фиксируют показы и предложения и закрывают договором. Каждый шаг остаётся с датой и ответственным.</p><h4>Что даёт контроль</h4><ul><li>В объявление идёт не старое фото из архива, а кадр этой недели.</li><li>Покупатель звонит в домофон у ворот, оператор видит его на видео и открывает дверь — сотруднику ехать не нужно.</li><li>Показы собираются в один день недели и остаются в журнале.</li></ul><h4>Измерение</h4><p>Показатель один: сколько дней прошло от объявления до договора. Предел — 365 дней, после него актив уходит в «безнадёжную» категорию; цель продать намного раньше.</p><p>Подробнее — на <a data-slayd='#s-sotuv' href='#'>слайде «Быстрая продажа»</a>.</p>"
    }
  },

  "s-tizim.indeks": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Nazorat indeksi: har aktivga 0 dan 100 gacha ball",
    tana: "<p>Indeks bitta savolga javob beradi: shu aktiv bo'yicha bank o'z majburiyatini bajaryaptimi. Ball saqlanmaydi, har ochilganda joriy ma'lumotdan qayta hisoblanadi.</p><table><tr><th>Tekshiruv</th><th>Og'irlik</th><th>Me'yor</th></tr><tr><td>Ko'rik dolzarbligi</td><td class='n'>25</td><td>Obyekt turiga ko'ra, misolda har 90 kunda</td></tr><tr><td>Sug'urta himoyasi</td><td class='n'>25</td><td>Polis amalda, summa bahodan kam emas</td></tr><tr><td>Baho dolzarbligi</td><td class='n'>20</td><td>12 oyda bir marta</td></tr><tr><td>Hujjatlar to'liqligi</td><td class='n'>15</td><td>Bosqich va qabul asosiga qarab majburiy hujjatlar ro'yxati</td></tr><tr><td>Qo'riqlash va qurilmalar</td><td class='n'>15</td><td>Shartnoma ham, ishlab turgan qurilma ham bo'lsa — to'liq ball</td></tr></table><p>Bugun ko'pchilik obyekt oxirgi banddan to'liq ball ololmaydi: shartnoma bor, qurilma yo'q. Loyiha tugagach shu 15 ball ochiladi va qamrov foizi oylik hisobotda o'lchanadigan raqamga aylanadi.</p><p>Suratdagi kartochkada indeks bloki «Joriy holat» dan pastda, o'sha ustunning davomida turadi: har tekshiruv o'z chizig'i, izohi va me'yori bilan ochiq yoziladi.</p><p class='ogoh'>Namoyish bazasidagi shartli obyektda bu ball 89 / 100. Bu haqiqiy portfel ko'rsatkichi emas.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Индекс контроля: от 0 до 100 баллов по каждому активу",
      tana: "<p>Индекс отвечает на один вопрос: выполняет ли банк свои обязательства по этому активу. Балл не хранится, он пересчитывается по текущим данным при каждом открытии.</p><table><tr><th>Проверка</th><th>Вес</th><th>Норматив</th></tr><tr><td>Актуальность осмотра</td><td class='n'>25</td><td>По типу объекта, в примере — раз в 90 дней</td></tr><tr><td>Страховая защита</td><td class='n'>25</td><td>Полис действует, сумма не ниже оценки</td></tr><tr><td>Актуальность оценки</td><td class='n'>20</td><td>Раз в 12 месяцев</td></tr><tr><td>Полнота документов</td><td class='n'>15</td><td>Перечень обязательных документов по стадии и основанию приёма</td></tr><tr><td>Охрана и устройства</td><td class='n'>15</td><td>Полный балл, когда есть и договор, и работающее устройство</td></tr></table><p>Сегодня большинство объектов не добирает баллы по последнему пункту: договор есть, устройства нет. После проекта эти 15 баллов открываются, а процент охвата становится цифрой, которую можно мерить в месячном отчёте.</p><p>На снимке блок индекса находится ниже «Текущего состояния», в продолжении той же колонки: каждая проверка выписана отдельной строкой с полосой, пояснением и нормативом.</p><p class='ogoh'>У условного объекта в демонстрационной базе этот балл равен 89 / 100. Это не показатель реального портфеля.</p>"
    }
  },

  "s-tizim.qamrov": {
    yorliq: "Rahbariyat uchun",
    sarlavha: "Ko'rik qamrovi: kechikish qayerda to'planadi",
    tana: "<p>Ko'rik rejasi ekranida to'rtta raqam turadi: rejadagi ko'riklar, shu oyda o'tkazilgani, kechikkanlar va me'yoriy muddatda ko'rilgan obyektlar ulushi. Shu ulush bugun rahbariyat qaraydigan yagona qamrov ko'rsatkichi.</p><h4>Kechikish nimadan kelib chiqadi</h4><ul><li>Uzoq obyektga safar bitta ish kunini oladi, brigada esa bitta.</li><li>Ko'rik sanasi sug'urta va baho muddatidan mustaqil, shuning uchun safarlar bir kunga tushmaydi.</li><li>Obyekt yopiq bo'lsa, inspektor qaytib keladi va sana yana suriladi.</li></ul><h4>Kamera qamrovni qanday o'zgartiradi</h4><p>Kamerali obyektda oraliq ko'rik masofadan o'tkaziladi: inspektor kadr va hodisalar tasmasini ko'radi, dalolatnomaga ilova qiladi. Joyida ko'rik me'yor talab qilganda va kamchilik topilganda qoladi, safarlar soni kamayadi.</p><p class='ogoh'>Suratdagi 213, 132, 54 va 80% — namoyish bazasining raqamlari, haqiqiy hisobot emas.</p>",
    manba: [],
    ru: {
      yorliq: "Для правления",
      sarlavha: "Охват осмотров: где копится просрочка",
      tana: "<p>На экране плана осмотров четыре цифры: осмотров в плане, проведено в этом месяце, просрочено и доля объектов, осмотренных в нормативный срок. Эта доля сегодня — единственный показатель охвата, на который смотрит правление.</p><h4>Откуда берётся просрочка</h4><ul><li>Выезд на удалённый объект занимает рабочий день, а бригада одна.</li><li>Дата осмотра не связана со сроками страховки и оценки, поэтому выезды не совмещаются.</li><li>Если объект закрыт, инспектор возвращается, и дата снова сдвигается.</li></ul><h4>Как камера меняет охват</h4><p>На объекте с камерой промежуточный осмотр проводится удалённо: инспектор смотрит кадр и ленту событий и прикладывает их к акту. Выезд остаётся там, где его требует норматив или где найдено замечание, и число поездок сокращается.</p><p class='ogoh'>Цифры 213, 132, 54 и 80% на снимке — из демонстрационной базы, это не реальная отчётность.</p>"
    }
  },

  "s-tizim.hodisa": {
    yorliq: "Xavfsizlik xizmati uchun",
    sarlavha: "Monitoring markazi: navbatchi nimani ko'radi",
    tana: "<p>Monitoring markazi — navbatchi operatorning ish o'rni. Ekran uchta savolga javob beradi: qaysi qurilma aloqada, qaysi signal ochiq qolgan va qaysi obyekt umuman himoyasiz.</p><table><tr><th>Blok</th><th>Nima uchun kerak</th></tr><tr><td>Aloqadagi qurilmalar</td><td>Aloqadan chiqqan qurilma servis navbatiga tushadi, obyekt ko'rinmaydigan holatda qolmaydi</td></tr><tr><td>24 soatdan ortiq jim</td><td>Batareya, SIM yoki antenna nosozligini ko'rsatadi</td></tr><tr><td>Qo'riqlanmayotgan obyektlar</td><td>Shartnomasi ham, qurilmasi ham yo'q ro'yxat — montaj navbati shundan tuziladi</td></tr><tr><td>So'nggi signallar</td><td>Har yozuv obyekt kartochkasiga bog'langan, kim ko'rgani jurnalda qoladi</td></tr></table><p>Ish signalni ko'rsatish bilan tugamaydi: operator videoni ochadi, kerak bo'lsa eshik yoki sirena buyrug'ini beradi va tasdiqlangan hodisani IIV Qo'riqlash departamenti pultiga uzatadi.</p><p class='ogoh'>Suratdagi qurilma va hodisa raqamlari namoyish bazasidan olingan.</p>",
    manba: [],
    ru: {
      yorliq: "Для службы безопасности",
      sarlavha: "Центр мониторинга: что видит дежурный",
      tana: "<p>Центр мониторинга — рабочее место дежурного оператора. Экран отвечает на три вопроса: какие устройства на связи, какая тревога осталась открытой и какой объект вообще без защиты.</p><table><tr><th>Блок</th><th>Зачем нужен</th></tr><tr><td>Устройства на связи</td><td>Пропавшее со связи устройство уходит в сервисную очередь, объект не остаётся невидимым</td></tr><tr><td>Молчат больше 24 часов</td><td>Признак неисправности батареи, SIM или антенны</td></tr><tr><td>Объекты без охраны</td><td>Список без договора и без устройств — из него собирается очередь на монтаж</td></tr><tr><td>Последние сигналы</td><td>Каждая запись привязана к карточке объекта, кто её открывал — остаётся в журнале</td></tr></table><p>Работа не заканчивается показом тревоги: оператор открывает видео, при необходимости отдаёт команду на дверь или сирену и передаёт подтверждённое событие на пульт Департамента охраны при МВД.</p><p class='ogoh'>Цифры по устройствам и событиям на снимке взяты из демонстрационной базы.</p>"
    }
  }
});
