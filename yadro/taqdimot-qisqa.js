  ...
  ru: {
    ...
    bloklar: [
      ...
      },
      {
        ...
        matn: "Сегодня объекты не охраняются, контроль — новый расход банка: 7,4 млн сумов в год на объект, около 1,6 млрд на 267 объектов. Команда, серверы и страховка — отдельные строки. Для сравнения: пост Департамента охраны 55 млн, сторож банка 145 млн сумов.",
        slayd: "#s-iqtisod",
        qoshimcha: []
      },
      {
